...
-- ----------------------------
INSERT INTO `gen_table` VALUES ('1196049947530584067', NULL, '', '', '', '', '', '', '2019-11-17 20:58:24', NULL, NULL, '0', 1);
...
CREATE TABLE `gen_table_column`  (
  ...
  `col_type` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '列的数据类型',
  `attr_type` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'JAVA类型',
  `attr` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'JAVA字段名',
  `attr_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'JAVA字段名',
  `primary_key` smallint(1) NULL DEFAULT NULL COMMENT '是否主键',
  `is_unique` smallint(1) NULL DEFAULT NULL COMMENT '是否唯一（1：是；0：否）',
  `is_not_null` smallint(1) NULL DEFAULT 1 COMMENT '是否可为空',
  `is_insert` smallint(1) NULL DEFAULT 0 COMMENT '是否为插入字段',
  `is_edit` smallint(1) NULL DEFAULT 0 COMMENT '是否编辑字段',
  `is_list` smallint(1) NULL DEFAULT 0 COMMENT '是否列表字段',
  `is_query` smallint(1) NULL DEFAULT 0 COMMENT '是否查询字段',
...
-- ----------------------------
INSERT INTO `onl_graphreport_head` VALUES ('1176746517590695939', '用户登录分析', 'a', 'SELECT create_by as name,count(1) as value FROM `sys_log_login`  GROUP BY create_by', 'name', 'value', 'tab', '登陆次数', 'SQL', 'bar,pie', '', NULL, NULL, '2019-09-25 14:33:27', 'admin', '2019-09-30 11:09:18', 'admin', '0', 1);
INSERT INTO `onl_graphreport_head` VALUES ('402881e64ca71152014ca71152480000', '用户操作统计', 'yhcztj', 'select a.create_by, count(*) ct from sys_log_login a  group by a.create_by order by ct desc', 'userid', 'x', 'tab', '操作次数', 'SQL', '', '用户操作统计', 'Y', 'function getTotalRows(totalRows) {\r\n    return [\'ct\', \'login_count\'];\r\n}', NULL, NULL, '2019-09-25 10:58:02', 'admin', '0', NULL);
...
CREATE TABLE `onl_graphreport_item`  (
  ...
  `is_graph` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否显示图表',
  `is_show` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否列表显示',
  `is_total` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否计算总计',
  `search_flag` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否查询',
...
-- ----------------------------
INSERT INTO `onl_graphreport_item` VALUES ('1178507080150790145', '1176746517590695939', 'value', '登录次数', NULL, NULL, NULL, NULL, 'Y', 'N', 'N', NULL, '', NULL, 'String', 2, NULL, 'admin', '2019-09-30 11:09:18', NULL, NULL, '0', 1);
INSERT INTO `onl_graphreport_item` VALUES ('1178507080268230657', '1176746517590695939', 'name', '账号', NULL, NULL, NULL, NULL, 'Y', 'N', 'Y', NULL, '', NULL, 'String', 1, NULL, 'admin', '2019-09-30 11:09:18', NULL, NULL, '0', 1);
...
INSERT INTO `qrtz_scheduler_state` VALUES ('quickdScheduler', 'LD-2018061113551569898998477', 1569899089061, 15000);
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('quickdScheduler', 'TASK_1067246875800000076', 'DEFAULT', 'TASK_1067246875800000076', 'DEFAULT', NULL, 1569900600000, -1, 5, 'WAITING', 'CRON', 1569541386000, 0, NULL, 2, );
...
-- Records of sys_code
-- ----------------------------
INSERT INTO `sys_code` VALUES (1123598812738675201, 'quickd-system', '岗位管理', 'sys_job', 'sys_', 'id', 'com.quickd.sys', 'D:\\developer\\code\\quickd\\quickd-system', 'D:\\developer\\code\\quickd-avue', 0);
...
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES ('4f1765520d6346f9bd9c79e2479e5b12', '57197590443c44f083d42ae24ef26a2c', '市场部', NULL, NULL, 0, NULL, '2', 'A02A01A02', NULL, NULL, NULL, NULL, NULL, '0', 'admin', '2019-02-20 17:15:34', 'admin', '2019-02-26 16:36:18', NULL);
INSERT INTO `sys_dept` VALUES ('5159cde220114246b045e574adceafe9', '57197590443c44f083d42ae24ef26a2c', '销售部', NULL, NULL, 0, NULL, '2', 'A02A01A01', NULL, NULL, NULL, NULL, NULL, '0', 'admin', '2019-02-26 16:44:38', 'admin', '2019-03-07 09:36:53', NULL);
INSERT INTO `sys_dept` VALUES ('57197590443c44f083d42ae24ef26a2c', '6d35e179cd814e3299bd588ea7daed3f', '华东分部', NULL, NULL, 0, NULL, '2', 'A01A01', NULL, NULL, NULL, NULL, NULL, '0', 'admin', '2019-02-21 16:14:41', 'admin', '2019-03-27 19:05:49', NULL);
INSERT INTO `sys_dept` VALUES ('6d35e179cd814e3299bd588ea7daed3f', '', 'QuickD', NULL, NULL, 0, NULL, '1', 'A01', NULL, NULL, NULL, NULL, NULL, '0', 'admin', '2019-02-26 16:36:39', 'admin', '2019-03-22 16:47:25', NULL);
INSERT INTO `sys_dept` VALUES ('743ba9dbdc114af8953a11022ef3096a', '6d35e179cd814e3299bd588ea7daed3f', '华南分部', NULL, NULL, 0, NULL, '2', 'A03A02', NULL, NULL, NULL, NULL, NULL, '0', 'admin', '2019-03-22 16:45:43', NULL, NULL, NULL);
INSERT INTO `sys_dept` VALUES ('a7d7e77e06c84325a40932163adcdaa6', '743ba9dbdc114af8953a11022ef3096a', '研发部', NULL, NULL, 0, NULL, '2', 'A02A02A01', NULL, NULL, NULL, NULL, NULL, '0', 'admin', '2019-02-26 16:36:47', 'admin', '2019-02-26 16:37:25', NULL);
INSERT INTO `sys_dept` VALUES ('c6d7cb4deeac411cb3384b1b31278596', '743ba9dbdc114af8953a11022ef3096a', '财务部', NULL, NULL, 0, NULL, '2', 'A02A02A02', NULL, NULL, NULL, NULL, NULL, '0', 'admin', '2019-02-11 14:21:51', 'admin', '2019-03-22 16:47:19', NULL);
...
-- Records of sys_dict
-- ----------------------------
INSERT INTO `sys_dict` VALUES ('0b5d19e1fce4b2e6647e6b4a17760c14', '通告类型', 'msg_category', '消息类型1:通知公告2:系统消息', 0, 'admin', '2019-04-22 18:01:35', 'admin', '2019-09-06 23:00:57', '0', NULL);
INSERT INTO `sys_dict` VALUES ('1213042878753759235', NULL, NULL, '', 0, 'admin', '2020-01-03 18:22:14', NULL, NULL, '0', 1);
...
INSERT INTO `sys_dict` VALUES ('3d9a351be3436fbefb1307d4cfb49bf2', '性别', 'sex', NULL, 1, NULL, '2019-01-04 14:56:32', 'admin', '2019-03-30 11:28:27', '0', NULL);
...
INSERT INTO `sys_dict` VALUES ('4c753b5293304e7a445fd2741b46529d', '字典状态', 'dict_item_status', NULL, 1, 'admin', '2019-05-09 16:31:52', 'admin', '2019-03-30 19:33:52', '0', NULL);
...
INSERT INTO `sys_dict` VALUES ('68168534ff5065a152bfab275c2136f8', '有效无效状态', 'valid_status', '有效无效状态', 0, 'admin', '2019-05-09 16:31:52', 'admin', '2019-04-26 19:21:23', '0', NULL);
INSERT INTO `sys_dict` VALUES ('6b78e3f59faec1a4750acff08030a79b', '用户类型', 'user_type', NULL, 0, NULL, '2019-01-04 14:59:01', 'admin', '2019-03-18 23:28:18', '1', NULL);
...
INSERT INTO `sys_dict` VALUES ('83bfb33147013cc81640d5fd9eda030c', '日志类型', 'log_type', NULL, 1, 'admin', '2019-03-18 23:22:19', NULL, NULL, '0', NULL);
INSERT INTO `sys_dict` VALUES ('845da5006c97754728bf48b6a10f79cc', '状态', 'status', NULL, 0, 'admin', '2019-03-18 21:45:25', 'admin', '2019-03-18 21:58:25', '1', NULL);
...
INSERT INTO `sys_dict` VALUES ('a7adbcd86c37f7dbc9b66945c82ef9e6', '1是0否', 'yn', '', 0, 'admin', '2019-05-22 19:29:29', NULL, NULL, '1', NULL);
...
INSERT INTO `sys_dict` VALUES ('ac2f7c0c5c5775fcea7e2387bcb22f01', '菜单类型', 'menu_type', NULL, 1, 'admin', '2019-05-09 16:31:52', 'admin', '2019-04-01 15:27:06', '0', NULL);
INSERT INTO `sys_dict` VALUES ('ad7c65ba97c20a6805d5dcdf13cdaf36', 'onlineT类型', 'ceshi_online', NULL, 0, 'admin', '2019-03-22 16:31:49', 'admin', '2019-03-22 16:34:16', '1', NULL);
...
INSERT INTO `sys_dict` VALUES ('d6e1152968b02d69ff358c75b48a6ee1', '流程类型', 'bpm_process_type', NULL, 0, 'admin', '2019-05-09 16:31:52', 'admin', '2019-03-30 18:14:44', '0', NULL);
INSERT INTO `sys_dict` VALUES ('fc6cd58fde2e8481db10d3a1e68ce70c', '用户状态', 'user_status', NULL, 1, 'admin', '2019-03-18 21:57:25', 'admin', '2019-03-18 23:11:58', '0', NULL);
...
-- ----------------------------
INSERT INTO `sys_dict_item` VALUES ('0072d115e07c875d76c9b022e2179128', '4d7fec1a7799a436d26d02325eff295e', '低', 'L', '低', 3, 1, 'admin', '2019-04-16 17:04:59', NULL, NULL, '1', 1);
INSERT INTO `sys_dict_item` VALUES ('05a2e732ce7b00aa52141ecc3e330b4e', '3486f32803bb953e7155dab3513dc68b', '已删除', '1', NULL, NULL, 1, 'admin', '2019-05-10 17:54:51', 'admin', '2019-03-28 22:23:20', '1', 1);
INSERT INTO `sys_dict_item` VALUES ('096c2e758d823def3855f6376bc736fb', 'bd1b8bc28e65d6feefefb6f3c79f42fd', 'SQL', 'sql', NULL, 1, 1, 'admin', '2019-04-12 17:26:26', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('0c9532916f5cd722017b46bc4d953e41', '2f0320997ade5dd147c90130f7218c3e', '指定用户', 'USER', NULL, NULL, 1, 'admin', '2019-03-17 21:22:19', 'admin', '2019-03-17 21:22:28', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('0ca4beba9efc4f9dd54af0911a946d5c', '72cce0989df68887546746d8f09811aa', '附表', '3', NULL, 3, 1, 'admin', '2019-03-27 10:13:43', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('1030a2652608f5eac3b49d70458b8532', '2e02df51611a4b9632828ab7e5338f00', '禁用', '2', '禁用', 2, 1, 'admin', '2019-05-10 17:54:51', 'admin', '2019-04-26 18:39:11', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('1169169062705111042', '3d9a351be3436fbefb1307d4cfb49bf2', '男', '0', '1111', 0, 0, NULL, NULL, NULL, NULL, '0', 3);
INSERT INTO `sys_dict_item` VALUES ('1169395221794574338', '0b5d19e1fce4b2e6647e6b4a17760c14', '333', '33', '33', 0, 1, 'admin', '2019-09-05 07:42:02', NULL, NULL, '1', 1);
INSERT INTO `sys_dict_item` VALUES ('1169510725165539330', '0b5d19e1fce4b2e6647e6b4a17760c14', 'test', '1', '11', 2, 1, 'admin', '2019-09-05 15:21:00', NULL, NULL, '1', 1);
INSERT INTO `sys_dict_item` VALUES ('1169988454575017986', '0b5d19e1fce4b2e6647e6b4a17760c14', '私信', '3', '', 3, 1, 'admin', '2019-09-06 22:59:20', NULL, NULL, '1', 1);
INSERT INTO `sys_dict_item` VALUES ('1169989357793218563', '4d7fec1a7799a436d26d02325eff295e', '低', 'L', '', 0, 1, 'admin', '2019-09-06 23:02:55', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('147c48ff4b51545032a9119d13f3222a', 'd6e1152968b02d69ff358c75b48a6ee1', '测试流程', 'test', NULL, 1, 1, 'admin', '2019-03-22 19:27:05', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('1543fe7e5e26fb97cdafe4981bedc0c8', '4c03fca6bf1f0299c381213961566349', '单排布局', 'single', NULL, 2, 1, 'admin', '2019-05-10 17:54:51', 'admin', '2019-04-12 17:43:57', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('1b8a6341163062dad8cb2fddd34e0c3b', '404a04a15f371566c658ee9ef9fc392a', '22', '222', NULL, 1, 1, 'admin', '2019-03-30 11:17:48', NULL, NULL, '0', 3);
INSERT INTO `sys_dict_item` VALUES ('1ce390c52453891f93514c1bd2795d44', 'ad7c65ba97c20a6805d5dcdf13cdaf36', '000', '00', NULL, 1, 1, 'admin', '2019-03-22 16:34:34', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('1db531bcff19649fa82a644c8a939dc4', '4c03fca6bf1f0299c381213961566349', '组合布局', 'combination', '', 4, 1, 'admin', '2019-05-11 16:07:08', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('222705e11ef0264d4214affff1fb4ff9', '4f69be5f507accea8d5df5f11346181a', '短信', '1', '', 1, 1, 'admin', '2019-05-10 17:54:51', 'admin', '2019-04-28 10:58:11', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('23a5bb76004ed0e39414e928c4cde155', '4e4602b3e3686f0911384e188dc7efb4', '不等于', '!=', '不等于', 3, 1, 'admin', '2019-04-01 16:46:15', 'admin', '2019-04-01 17:48:40', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('25847e9cb661a7c711f9998452dc09e6', '4e4602b3e3686f0911384e188dc7efb4', '小于等于', '<=', '小于等于', 6, 1, 'admin', '2019-04-01 16:44:34', 'admin', '2019-04-01 17:49:10', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('2d51376643f220afdeb6d216a8ac2c01', '68168534ff5065a152bfab275c2136f8', '有效', '1', '有效', 2, 1, 'admin', '2019-04-26 19:22:01', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('308c8aadf0c37ecdde188b97ca9833f5', '8dfe32e2d29ea9430a988b3b558bf233', '已发布', '1', '已发布', 2, 1, 'admin', '2019-04-16 17:41:24', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('333e6b2196e01ef9a5f76d74e86a6e33', '8dfe32e2d29ea9430a988b3b558bf233', '未发布', '0', '未发布', 1, 1, 'admin', '2019-04-16 17:41:12', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('337ea1e401bda7233f6258c284ce4f50', 'bd1b8bc28e65d6feefefb6f3c79f42fd', 'JSON', 'json', NULL, 1, 1, 'admin', '2019-04-12 17:26:33', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('33bc9d9f753cf7dc40e70461e50fdc54', 'a9d9942bd0eccb6e89de92d130ec4c4a', '发送失败', '2', NULL, 3, 1, 'admin', '2019-04-12 18:20:02', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('3fbc03d6c994ae06d083751248037c0e', '78bda155fe380b1b3f175f1e88c284c6', '已完成', '3', '已完成', 3, 1, 'admin', '2019-05-09 16:33:25', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('41d7aaa40c9b61756ffb1f28da5ead8e', '0b5d19e1fce4b2e6647e6b4a17760c14', '通知公告', '1', NULL, 1, 1, 'admin', '2019-04-22 18:01:57', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('41fa1e9571505d643aea87aeb83d4d76', '4e4602b3e3686f0911384e188dc7efb4', '等于', '=', '等于', 4, 1, 'admin', '2019-04-01 16:45:24', 'admin', '2019-04-01 17:49:00', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('43d2295b8610adce9510ff196a49c6e9', '845da5006c97754728bf48b6a10f79cc', '正常', '1', NULL, NULL, 1, 'admin', '2019-03-18 21:45:51', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('4f05fb5376f4c61502c5105f52e4dd2b', '83bfb33147013cc81640d5fd9eda030c', '操作日志', '2', NULL, NULL, 1, 'admin', '2019-03-18 23:22:49', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('50223341bfb5ba30bf6319789d8d17fe', 'd6e1152968b02d69ff358c75b48a6ee1', '业务办理', 'business', NULL, 3, 1, 'admin', '2019-05-10 17:54:51', 'admin', '2019-03-22 23:24:39', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('51222413e5906cdaf160bb5c86fb827c', 'a7adbcd86c37f7dbc9b66945c82ef9e6', '是', '1', '', 1, 1, 'admin', '2019-05-22 19:29:45', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('538fca35afe004972c5f3947c039e766', '2e02df51611a4b9632828ab7e5338f00', '显示', '1', '显示', 1, 1, 'admin', '2019-05-10 17:54:51', 'admin', '2019-04-26 18:39:07', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('5584c21993bde231bbde2b966f2633ac', '4e4602b3e3686f0911384e188dc7efb4', '自定义SQL表达式', 'USE_SQL_RULES', '自定义SQL表达式', 9, 1, 'admin', '2019-04-01 10:45:24', 'admin', '2019-04-01 17:49:27', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('58b73b344305c99b9d8db0fc056bbc0a', '72cce0989df68887546746d8f09811aa', '主表', '2', NULL, 2, 1, 'admin', '2019-03-27 10:13:36', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('5b65a88f076b32e8e69d19bbaadb52d5', '2f0320997ade5dd147c90130f7218c3e', '全体用户', 'ALL', NULL, NULL, 1, 'admin', '2019-05-10 17:54:51', 'admin', '2019-03-28 22:17:09', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('5d84a8634c8fdfe96275385075b105c9', '3d9a351be3436fbefb1307d4cfb49bf2', '女', '2', NULL, 2, 1, NULL, '2019-01-04 14:56:56', NULL, '2019-01-04 17:38:12', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('66c952ae2c3701a993e7db58f3baf55e', '4e4602b3e3686f0911384e188dc7efb4', '大于', '>', '大于', 1, 1, 'admin', '2019-04-01 10:45:46', 'admin', '2019-04-01 17:48:29', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('6937c5dde8f92e9a00d4e2ded9198694', 'ad7c65ba97c20a6805d5dcdf13cdaf36', 'easyui', '3', NULL, 1, 1, 'admin', '2019-03-22 16:32:15', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('69cacf64e244100289ddd4aa9fa3b915', 'a9d9942bd0eccb6e89de92d130ec4c4a', '未发送', '0', NULL, 1, 1, 'admin', '2019-04-12 18:19:23', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('6a7a9e1403a7943aba69e54ebeff9762', '4f69be5f507accea8d5df5f11346181a', '邮件', '2', '', 2, 1, 'admin', '2019-05-10 17:54:51', 'admin', '2019-04-28 10:59:03', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('6c682d78ddf1715baf79a1d52d2aa8c2', '72cce0989df68887546746d8f09811aa', '单表', '1', NULL, 1, 1, 'admin', '2019-03-27 10:13:29', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('6d404fd2d82311fbc87722cd302a28bc', '4e4602b3e3686f0911384e188dc7efb4', '模糊', 'LIKE', '模糊', 7, 1, 'admin', '2019-04-01 16:46:02', 'admin', '2019-04-01 17:49:20', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('6d4e26e78e1a09699182e08516c49fc4', '4d7fec1a7799a436d26d02325eff295e', '高', 'H', '高', 1, 1, 'admin', '2019-04-16 17:04:24', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('700e9f030654f3f90e9ba76ab0713551', '6b78e3f59faec1a4750acff08030a79b', '非管理员', '0', NULL, NULL, 1, 'admin', '2019-02-21 19:59:47', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('7050c1522702bac3be40e3b7d2e1dfd8', 'c5a14c75172783d72cbee6ee7f5df5d1', '柱状图', 'bar', NULL, 1, 1, 'admin', '2019-04-12 17:05:17', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('71b924faa93805c5c1579f12e001c809', 'd6e1152968b02d69ff358c75b48a6ee1', 'OA办公', 'oa', NULL, 2, 1, 'admin', '2019-05-10 17:54:51', 'admin', '2019-03-22 23:24:36', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('75b260d7db45a39fc7f21badeabdb0ed', 'c36169beb12de8a71c8683ee7c28a503', '不启用', '0', NULL, NULL, 1, 'admin', '2019-03-18 23:29:41', 'admin', '2019-03-18 23:29:54', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('7688469db4a3eba61e6e35578dc7c2e5', 'c36169beb12de8a71c8683ee7c28a503', '启用', '1', NULL, NULL, 1, 'admin', '2019-03-18 23:29:28', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('78ea6cadac457967a4b1c4eb7aaa418c', 'fc6cd58fde2e8481db10d3a1e68ce70c', '正常', '1', NULL, NULL, 1, 'admin', '2019-03-18 23:30:28', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('7ccf7b80c70ee002eceb3116854b75cb', 'ac2f7c0c5c5775fcea7e2387bcb22f01', '按钮权限', '2', NULL, NULL, 1, 'admin', '2019-03-18 23:25:40', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('81fb2bb0e838dc68b43f96cc309f8257', 'fc6cd58fde2e8481db10d3a1e68ce70c', '冻结', '2', NULL, NULL, 1, 'admin', '2019-03-18 23:30:37', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('83250269359855501ec4e9c0b7e21596', '4274efc2292239b6f000b153f50823ff', '显示/访问(授权后显示/可访问)', '1', '', 1, 1, 'admin', '2019-05-10 17:54:51', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('84778d7e928bc843ad4756db1322301f', '4e4602b3e3686f0911384e188dc7efb4', '大于等于', '>=', '大于等于', 5, 1, 'admin', '2019-04-01 10:46:02', 'admin', '2019-04-01 17:49:05', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('848d4da35ebd93782029c57b103e5b36', 'c5a14c75172783d72cbee6ee7f5df5d1', '饼图', 'pie', NULL, 3, 1, 'admin', '2019-04-12 17:05:49', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('84dfc178dd61b95a72900fcdd624c471', '78bda155fe380b1b3f175f1e88c284c6', '处理中', '2', '处理中', 2, 1, 'admin', '2019-05-09 16:33:01', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('86f19c7e0a73a0bae451021ac05b99dd', 'ac2f7c0c5c5775fcea7e2387bcb22f01', '子菜单', '1', NULL, NULL, 1, 'admin', '2019-03-18 23:25:27', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('8bccb963e1cd9e8d42482c54cc609ca2', '4f69be5f507accea8d5df5f11346181a', '微信', '3', NULL, 3, 1, 'admin', '2019-05-10 17:54:51', 'admin', '2019-04-11 14:29:31', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('8c618902365ca681ebbbe1e28f11a548', '4c753b5293304e7a445fd2741b46529d', '启用', '1', '', 0, 1, 'admin', '2019-05-10 17:54:51', 'admin', '2019-05-17 14:51:18', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('8cdf08045056671efd10677b8456c999', '4274efc2292239b6f000b153f50823ff', '可编辑(未授权时禁用)', '2', '', 2, 1, 'admin', '2019-05-10 17:55:38', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('8ff48e657a7c5090d4f2a59b37d1b878', '4d7fec1a7799a436d26d02325eff295e', '中', 'M', '中', 2, 1, 'admin', '2019-04-16 17:04:40', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('9a96c4a4e4c5c9b4e4d0cbf6eb3243cc', '4c753b5293304e7a445fd2741b46529d', '不启用', '0', NULL, 1, 1, 'admin', '2019-03-18 23:19:53', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('a2321496db6febc956a6c70fab94cb0c', '404a04a15f371566c658ee9ef9fc392a', '3', '3', NULL, 1, 1, 'admin', '2019-03-30 11:18:18', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('a2be752dd4ec980afaec1efd1fb589af', '8dfe32e2d29ea9430a988b3b558bf233', '已撤销', '2', '已撤销', 3, 1, 'admin', '2019-04-16 17:41:39', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('aa0d8a8042a18715a17f0a888d360aa4', 'ac2f7c0c5c5775fcea7e2387bcb22f01', '一级菜单', '0', NULL, NULL, 1, 'admin', '2019-03-18 23:24:52', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('adcf2a1fe93bb99a84833043f475fe0b', '4e4602b3e3686f0911384e188dc7efb4', '包含', 'IN', '包含', 8, 1, 'admin', '2019-04-01 16:45:47', 'admin', '2019-04-01 17:49:24', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('b029a41a851465332ee4ee69dcf0a4c2', '0b5d19e1fce4b2e6647e6b4a17760c14', '系统消息', '2', NULL, 1, 1, 'admin', '2019-02-22 18:02:08', 'admin', '2019-04-22 18:02:13', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('b2a8b4bb2c8e66c2c4b1bb086337f393', '3486f32803bb953e7155dab3513dc68b', '正常', '0', NULL, NULL, 1, 'admin', '2019-05-10 17:54:51', 'admin', '2019-03-28 22:22:20', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('b57f98b88363188daf38d42f25991956', '6b78e3f59faec1a4750acff08030a79b', '系统管理员', '1', NULL, NULL, 0, 'admin', '2019-02-21 19:59:43', 'admin', '2019-03-11 21:23:27', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('b5f3bd5f66bb9a83fecd89228c0d93d1', '68168534ff5065a152bfab275c2136f8', '无效', '0', '无效', 1, 1, 'admin', '2019-04-26 19:21:49', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('b9fbe2a3602d4a27b45c100ac5328484', '78bda155fe380b1b3f175f1e88c284c6', '待提交', '1', '待提交', 1, 1, 'admin', '2019-05-09 16:32:35', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('ba27737829c6e0e582e334832703d75e', '236e8a4baff0db8c62c00dd95632834f', '同步', '1', '同步', 1, 1, 'admin', '2019-05-15 15:28:15', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('c5700a71ad08994d18ad1dacc37a71a9', 'a7adbcd86c37f7dbc9b66945c82ef9e6', '否', '0', '', 1, 1, 'admin', '2019-05-22 19:29:55', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('cbfcc5b88fc3a90975df23ffc8cbe29c', 'c5a14c75172783d72cbee6ee7f5df5d1', '曲线图', 'line', NULL, 2, 1, 'admin', '2019-05-12 17:05:30', 'admin', '2019-04-12 17:06:06', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('d217592908ea3e00ff986ce97f24fb98', 'c5a14c75172783d72cbee6ee7f5df5d1', '数据列表', 'table', NULL, 4, 1, 'admin', '2019-04-12 17:05:56', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('df168368dcef46cade2aadd80100d8aa', '3d9a351be3436fbefb1307d4cfb49bf2', '男', '1', NULL, 1, 1, NULL, '2019-05-10 17:54:51', 'admin', '2019-03-23 22:44:44', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('e6329e3a66a003819e2eb830b0ca2ea0', '4e4602b3e3686f0911384e188dc7efb4', '小于', '<', '小于', 2, 1, 'admin', '2019-04-01 16:44:15', 'admin', '2019-04-01 17:48:34', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('e94eb7af89f1dbfa0d823580a7a6e66a', '236e8a4baff0db8c62c00dd95632834f', '不同步', '0', '不同步', 2, 1, 'admin', '2019-05-15 15:28:28', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('f0162f4cc572c9273f3e26b2b4d8c082', 'ad7c65ba97c20a6805d5dcdf13cdaf36', 'booostrap', '1', NULL, 1, 1, 'admin', '2019-05-10 17:54:51', 'admin', '2019-03-22 16:33:57', '0', 1);
INSERT INTO `sys_dict_item` VALUES ('f16c5706f3ae05c57a53850c64ce7c45', 'a9d9942bd0eccb6e89de92d130ec4c4a', '发送成功', '1', NULL, 2, 1, 'admin', '2019-04-12 18:19:43', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('f2a7920421f3335afdf6ad2b342f6b5d', '845da5006c97754728bf48b6a10f79cc', '冻结', '2', NULL, NULL, 1, 'admin', '2019-03-18 21:46:02', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('f37f90c496ec9841c4c326b065e00bb2', '83bfb33147013cc81640d5fd9eda030c', '登录日志', '1', NULL, NULL, 1, 'admin', '2019-03-18 23:22:37', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('f753aff60ff3931c0ecb4812d8b5e643', '4c03fca6bf1f0299c381213961566349', '双排布局', 'double', NULL, 3, 1, 'admin', '2019-04-12 17:43:51', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('fcec03570f68a175e1964808dc3f1c91', '4c03fca6bf1f0299c381213961566349', 'Tab风格', 'tab', NULL, 1, 1, 'admin', '2019-04-12 17:43:31', NULL, NULL, '0', 1);
INSERT INTO `sys_dict_item` VALUES ('fe50b23ae5e68434def76f67cef35d2d', '78bda155fe380b1b3f175f1e88c284c6', '已作废', '4', '已作废', 4, 1, 'admin', '2019-05-10 17:54:51', 'admin', '2019-05-09 16:34:40', '0', 1);
...
-- Records of sys_job
-- ----------------------------
INSERT INTO `sys_job` VALUES ('10', '产品经理', b'0', 4, '2', '2019-03-29 14:55:51', NULL, NULL, NULL, '1', 1);
INSERT INTO `sys_job` VALUES ('11', '全栈开发', b'1', 6, '2', '2019-03-31 13:39:30', NULL, NULL, NULL, '1', 1);
...
INSERT INTO `sys_job` VALUES ('2', '董事长秘书', b'1', 2, '1', '2019-03-29 14:01:30', NULL, NULL, NULL, '1', 1);
INSERT INTO `sys_job` VALUES ('8', '人事专员', b'1', 3, '11', '2019-03-29 14:52:28', NULL, NULL, NULL, '1', 1);
...
-- ----------------------------
INSERT INTO `sys_log_login` VALUES ('1177367340297957378', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', NULL, 'admin', '2019-09-27 07:40:23');
INSERT INTO `sys_log_login` VALUES ('1177412905316532226', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', NULL, 'admin', '2019-09-27 10:41:27');
INSERT INTO `sys_log_login` VALUES ('1177482429751554050', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', NULL, 'admin', '2019-09-27 15:17:42');
INSERT INTO `sys_log_login` VALUES ('1178204510847991810', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'system', '2019-09-29 15:07:00');
INSERT INTO `sys_log_login` VALUES ('1178211694205960194', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'system', '2019-09-29 15:35:33');
INSERT INTO `sys_log_login` VALUES ('1178217451261493251', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'system', '2019-09-29 15:58:25');
INSERT INTO `sys_log_login` VALUES ('1178224725338013699', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'system', '2019-09-29 16:27:22');
INSERT INTO `sys_log_login` VALUES ('1178228842093527043', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'system', '2019-09-29 16:43:41');
INSERT INTO `sys_log_login` VALUES ('1178230663402958850', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'system', '2019-09-29 16:50:55');
INSERT INTO `sys_log_login` VALUES ('1178231365374230530', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'system', '2019-09-29 16:53:43');
INSERT INTO `sys_log_login` VALUES ('1178237272367726595', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-09-29 17:17:13');
INSERT INTO `sys_log_login` VALUES ('1178846837367046146', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-01 09:39:23');
INSERT INTO `sys_log_login` VALUES ('1178954810149457922', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-01 16:48:25');
INSERT INTO `sys_log_login` VALUES ('1182474827729952770', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3759.4 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-11 09:55:43');
INSERT INTO `sys_log_login` VALUES ('1182475194857381890', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3759.4 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-11 09:57:10');
INSERT INTO `sys_log_login` VALUES ('1182481452561817603', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-11 10:22:02');
INSERT INTO `sys_log_login` VALUES ('1182484529226407939', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-11 10:34:16');
INSERT INTO `sys_log_login` VALUES ('1182541102372052995', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-11 14:19:04');
INSERT INTO `sys_log_login` VALUES ('1182561946498457602', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-11 15:41:54');
INSERT INTO `sys_log_login` VALUES ('1182948967335288835', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64; rv:56.0) Gecko/20100101 Firefox/56.0', '127.0.0.1', '内网IP', 'admin', '2019-10-12 17:19:47');
INSERT INTO `sys_log_login` VALUES ('1183586588495405058', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-14 11:33:27');
INSERT INTO `sys_log_login` VALUES ('1183589244236423171', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'hry', '2019-10-14 11:44:01');
INSERT INTO `sys_log_login` VALUES ('1183589377149722627', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'hry', '2019-10-14 11:44:32');
INSERT INTO `sys_log_login` VALUES ('1183628171882225666', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'hry', '2019-10-14 14:18:42');
INSERT INTO `sys_log_login` VALUES ('1183628768610050051', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3732.400 QQBrowser/10.5.3819.400', '127.0.0.1', '内网IP', 'hry', '2019-10-14 14:21:04');
INSERT INTO `sys_log_login` VALUES ('1183629674000900099', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'hry', '2019-10-14 14:24:40');
INSERT INTO `sys_log_login` VALUES ('1183629920663724035', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.131 Safari/537.36', '127.0.0.1', '内网IP', 'hry', '2019-10-14 14:25:39');
INSERT INTO `sys_log_login` VALUES ('1183630725374500867', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'hry', '2019-10-14 14:28:50');
INSERT INTO `sys_log_login` VALUES ('1183631063829667843', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'hry', '2019-10-14 14:30:11');
INSERT INTO `sys_log_login` VALUES ('1183631324358860803', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-14 14:31:13');
INSERT INTO `sys_log_login` VALUES ('1183631401764741123', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-14 14:31:32');
INSERT INTO `sys_log_login` VALUES ('1183632552023252995', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-14 14:36:06');
INSERT INTO `sys_log_login` VALUES ('1183632898766364675', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-14 14:37:29');
INSERT INTO `sys_log_login` VALUES ('1183632943939018754', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.50 Safari/537.36 Edg/78.0.276.17', '127.0.0.1', '内网IP', 'admin', '2019-10-14 14:37:39');
INSERT INTO `sys_log_login` VALUES ('1183634720809771011', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-14 14:44:43');
INSERT INTO `sys_log_login` VALUES ('1183634953505562626', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3732.400 QQBrowser/10.5.3819.400', '127.0.0.1', '内网IP', 'admin', '2019-10-14 14:45:38');
INSERT INTO `sys_log_login` VALUES ('1183637174783795202', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-14 14:54:28');
INSERT INTO `sys_log_login` VALUES ('1183643797711446018', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-14 15:20:47');
INSERT INTO `sys_log_login` VALUES ('1183649707947155459', 0, 1, 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_1_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 QQ/6.5.5.0 TIM/2.3.0.401 V1_IPH_SQ_6.5.5_1_TIM_D Pixel/1125 Core/UIWebView Device/Apple(iPhone X) NetType/4G', '127.0.0.1', '内网IP', 'admin', '2019-10-14 15:44:16');
INSERT INTO `sys_log_login` VALUES ('1183649863459364866', 0, 1, 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_1_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.1 Mobile/15E148 Safari/604.1', '127.0.0.1', '内网IP', 'admin', '2019-10-14 15:44:53');
INSERT INTO `sys_log_login` VALUES ('1183657824109944834', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3732.400 QQBrowser/10.5.3819.400', '127.0.0.1', '内网IP', 'admin', '2019-10-14 16:16:31');
INSERT INTO `sys_log_login` VALUES ('1183659996704890882', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:69.0) Gecko/20100101 Firefox/69.0', '127.0.0.1', '内网IP', 'admin', '2019-10-14 16:25:09');
INSERT INTO `sys_log_login` VALUES ('1183661160695554050', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:69.0) Gecko/20100101 Firefox/69.0', '127.0.0.1', '内网IP', 'demo', '2019-10-14 16:29:47');
INSERT INTO `sys_log_login` VALUES ('1183661200767934466', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:69.0) Gecko/20100101 Firefox/69.0', '127.0.0.1', '内网IP', 'admin', '2019-10-14 16:29:56');
INSERT INTO `sys_log_login` VALUES ('1183661839287803906', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.116 Safari/537.36 QBCore/3.53.1031.400 QQBrowser/9.0.2524.400', '127.0.0.1', '内网IP', 'admin', '2019-10-14 16:32:29');
INSERT INTO `sys_log_login` VALUES ('1183661979146870787', 0, 1, 'Mozilla/5.0 (Linux; Android 8.1.0; MI 5X Build/OPM1.171019.019; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/66.0.3359.126 MQQBrowser/6.2 TBS/044904 Mobile Safari/537.36 MMWEBID/5263 MicroMessenger/7.0.7.1521(0x27000739) Process/tools NetType/WIFI Language/zh_CN', '127.0.0.1', '内网IP', 'admin', '2019-10-14 16:33:02');
INSERT INTO `sys_log_login` VALUES ('1183664899363921922', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-14 16:44:38');
INSERT INTO `sys_log_login` VALUES ('1183668283512938498', 0, 1, 'Mozilla/5.0 (Linux; Android 7.1.2; M6 Note Build/N2G47H; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/66.0.3359.126 MQQBrowser/6.2 TBS/044904 Mobile Safari/537.36 V1_AND_SQ_8.1.5_1258_YYB_D QQ/8.1.5.4215 NetType/WIFI WebP/0.3.0 Pixel/1080 StatusBarHeight/66 SimpleUISwitch/0', '127.0.0.1', '内网IP', 'admin', '2019-10-14 16:58:05');
INSERT INTO `sys_log_login` VALUES ('1183669364489936899', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-14 17:02:23');
INSERT INTO `sys_log_login` VALUES ('1183694810472472579', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-14 18:43:29');
INSERT INTO `sys_log_login` VALUES ('1183695468294529026', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-14 18:46:06');
INSERT INTO `sys_log_login` VALUES ('1183696013621157891', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-14 18:48:16');
INSERT INTO `sys_log_login` VALUES ('1183909482979090435', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 08:56:31');
INSERT INTO `sys_log_login` VALUES ('1183915453344342019', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 09:20:15');
INSERT INTO `sys_log_login` VALUES ('1183918009437085698', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 09:30:24');
INSERT INTO `sys_log_login` VALUES ('1183929028305707011', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3732.400 QQBrowser/10.5.3819.400', '127.0.0.1', '内网IP', 'admin', '2019-10-15 10:14:11');
INSERT INTO `sys_log_login` VALUES ('1183929034353893379', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.116 Safari/537.36 QBCore/4.0.1278.400 QQBrowser/9.0.2524.400 Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2875.116 Safari/537.36 NetType/WIFI MicroMessenger/7.0.5 WindowsWechat', '127.0.0.1', '内网IP', 'admin', '2019-10-15 10:14:13');
INSERT INTO `sys_log_login` VALUES ('1183929075432906754', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'google', '2019-10-15 10:14:23');
INSERT INTO `sys_log_login` VALUES ('1183929854302576643', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', '127.0.0.1', '内网IP', 'google', '2019-10-15 10:17:28');
INSERT INTO `sys_log_login` VALUES ('1183929951136473091', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', '127.0.0.1', '内网IP', 'google', '2019-10-15 10:17:51');
INSERT INTO `sys_log_login` VALUES ('1183930074419650563', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', '127.0.0.1', '内网IP', 'google', '2019-10-15 10:18:21');
INSERT INTO `sys_log_login` VALUES ('1183930719562326019', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'google', '2019-10-15 10:20:55');
INSERT INTO `sys_log_login` VALUES ('1183932006865526787', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'google', '2019-10-15 10:26:01');
INSERT INTO `sys_log_login` VALUES ('1183932470260621314', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'google', '2019-10-15 10:27:52');
INSERT INTO `sys_log_login` VALUES ('1183933129936560131', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'google', '2019-10-15 10:30:29');
INSERT INTO `sys_log_login` VALUES ('1183937662599258115', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', '127.0.0.1', '内网IP', 'google', '2019-10-15 10:48:30');
INSERT INTO `sys_log_login` VALUES ('1183938760781291523', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 10:52:52');
INSERT INTO `sys_log_login` VALUES ('1183939726733697026', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 10:56:42');
INSERT INTO `sys_log_login` VALUES ('1183940078627414019', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 10:58:06');
INSERT INTO `sys_log_login` VALUES ('1183940078753243139', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 10:58:06');
INSERT INTO `sys_log_login` VALUES ('1183941175081394179', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 11:02:27');
INSERT INTO `sys_log_login` VALUES ('1183942090022674435', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:69.0) Gecko/20100101 Firefox/69.0', '127.0.0.1', '内网IP', 'admin', '2019-10-15 11:06:05');
INSERT INTO `sys_log_login` VALUES ('1183942698846871554', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3650.400 QQBrowser/10.4.3341.400', '127.0.0.1', '内网IP', 'admin', '2019-10-15 11:08:31');
INSERT INTO `sys_log_login` VALUES ('1183950819560480771', 0, 1, 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_1_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 QQ/8.1.5.461 V1_IPH_SQ_8.1.5_1_APP_A Pixel/750 Core/WKWebView Device/Apple(iPhone 7) NetType/WIFI QBWebViewType/1 WKType/1', '127.0.0.1', '内网IP', 'admin', '2019-10-15 11:40:47');
INSERT INTO `sys_log_login` VALUES ('1183953337866739714', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 11:50:47');
INSERT INTO `sys_log_login` VALUES ('1183957047338557443', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 12:05:32');
INSERT INTO `sys_log_login` VALUES ('1183979320854405123', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 13:34:02');
INSERT INTO `sys_log_login` VALUES ('1183982267512348675', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 13:45:45');
INSERT INTO `sys_log_login` VALUES ('1183989675773091843', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 14:15:11');
INSERT INTO `sys_log_login` VALUES ('1183989779590504451', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 14:15:36');
INSERT INTO `sys_log_login` VALUES ('1183995817647628290', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 14:39:35');
INSERT INTO `sys_log_login` VALUES ('1184015068504743939', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 15:56:05');
INSERT INTO `sys_log_login` VALUES ('1184025622606733315', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 16:38:01');
INSERT INTO `sys_log_login` VALUES ('1184026153039388675', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 16:40:08');
INSERT INTO `sys_log_login` VALUES ('1184085116082675715', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 20:34:26');
INSERT INTO `sys_log_login` VALUES ('1184099603607150595', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 21:32:00');
INSERT INTO `sys_log_login` VALUES ('1184111463786045443', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 22:19:07');
INSERT INTO `sys_log_login` VALUES ('1184113467262459906', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-15 22:27:05');
INSERT INTO `sys_log_login` VALUES ('1184154591121334274', 0, 1, 'Mozilla/5.0 (iPad; CPU OS 13_1_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148', '127.0.0.1', '内网IP', 'admin', '2019-10-16 01:10:30');
INSERT INTO `sys_log_login` VALUES ('1184291550049296386', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-16 10:14:43');
INSERT INTO `sys_log_login` VALUES ('1184295895088193538', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-16 10:31:59');
INSERT INTO `sys_log_login` VALUES ('1184299249130496003', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-16 10:45:19');
INSERT INTO `sys_log_login` VALUES ('1184361380702019587', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-16 14:52:12');
INSERT INTO `sys_log_login` VALUES ('1184367122200879106', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-16 15:15:01');
INSERT INTO `sys_log_login` VALUES ('1184368145233567747', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36 OPR/63.0.3368.107', '127.0.0.1', '内网IP', 'admin', '2019-10-16 15:19:05');
INSERT INTO `sys_log_login` VALUES ('1184380318290763779', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-16 16:07:27');
INSERT INTO `sys_log_login` VALUES ('1184399061137973250', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-16 17:21:56');
INSERT INTO `sys_log_login` VALUES ('1184668551046193155', 0, 1, 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.98 Safari/537.36 LBBROWSER', '127.0.0.1', '内网IP', 'admin', '2019-10-17 11:12:47');
INSERT INTO `sys_log_login` VALUES ('1184722601578029059', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-17 14:47:34');
INSERT INTO `sys_log_login` VALUES ('1184757104002424834', 0, 1, 'Mozilla/5.0 (Linux; Android 9; MIX 2S Build/PKQ1.180729.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/72.0.3626.121 Mobile Safari/537.36 Nga_Official/80025', '127.0.0.1', '内网IP', 'admin', '2019-10-17 17:04:40');
INSERT INTO `sys_log_login` VALUES ('1184800964971814915', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-17 19:58:57');
INSERT INTO `sys_log_login` VALUES ('1184940099309101059', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:69.0) Gecko/20100101 Firefox/69.0', '127.0.0.1', '内网IP', 'admin', '2019-10-18 05:11:49');
INSERT INTO `sys_log_login` VALUES ('1185020291167772674', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3732.400 QQBrowser/10.5.3819.400', '127.0.0.1', '内网IP', 'admin', '2019-10-18 10:30:29');
INSERT INTO `sys_log_login` VALUES ('1185035377101987843', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-18 11:30:25');
INSERT INTO `sys_log_login` VALUES ('1185138694410952707', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-18 18:20:58');
INSERT INTO `sys_log_login` VALUES ('1185720579361038338', 0, 1, 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_1_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.1 Mobile/15E148 Safari/604.1', '127.0.0.1', '内网IP', 'admin', '2019-10-20 08:53:10');
INSERT INTO `sys_log_login` VALUES ('1186078074877206531', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-21 08:33:44');
INSERT INTO `sys_log_login` VALUES ('1186138305413996546', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3732.400 QQBrowser/10.5.3819.400', '127.0.0.1', '内网IP', 'admin', '2019-10-21 12:33:04');
INSERT INTO `sys_log_login` VALUES ('1186590617609658370', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-22 18:30:24');
INSERT INTO `sys_log_login` VALUES ('1186640745632587779', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-22 21:49:35');
INSERT INTO `sys_log_login` VALUES ('1186838034586230787', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3732.400 QQBrowser/10.5.3819.400', '127.0.0.1', '内网IP', 'admin', '2019-10-23 10:53:32');
INSERT INTO `sys_log_login` VALUES ('1186840122267492355', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-23 11:01:50');
INSERT INTO `sys_log_login` VALUES ('1186846902842253314', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-23 11:28:47');
INSERT INTO `sys_log_login` VALUES ('1186886003545038850', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-23 14:04:09');
INSERT INTO `sys_log_login` VALUES ('1186887001109913602', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-23 14:08:07');
INSERT INTO `sys_log_login` VALUES ('1186895516385894403', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-23 14:41:57');
INSERT INTO `sys_log_login` VALUES ('1186899052536487938', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-23 14:56:00');
INSERT INTO `sys_log_login` VALUES ('1186943591066329090', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-23 17:52:59');
INSERT INTO `sys_log_login` VALUES ('1187212124144754690', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0', '127.0.0.1', '内网IP', 'admin', '2019-10-24 11:40:02');
INSERT INTO `sys_log_login` VALUES ('1187251470298210306', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-24 14:16:23');
INSERT INTO `sys_log_login` VALUES ('1187262507659517954', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36 Edge/18.18362', '127.0.0.1', '内网IP', 'admin', '2019-10-24 15:00:15');
INSERT INTO `sys_log_login` VALUES ('1187585669009989635', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-25 12:24:22');
INSERT INTO `sys_log_login` VALUES ('1187586120824610818', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-25 12:26:10');
INSERT INTO `sys_log_login` VALUES ('1187586171382751235', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-25 12:26:22');
INSERT INTO `sys_log_login` VALUES ('1187997891007832066', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-26 15:42:24');
INSERT INTO `sys_log_login` VALUES ('1188002068886937602', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-26 15:59:00');
INSERT INTO `sys_log_login` VALUES ('1188005879768637443', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-26 16:14:08');
INSERT INTO `sys_log_login` VALUES ('1188006023968808963', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-26 16:14:43');
INSERT INTO `sys_log_login` VALUES ('1188022061116645379', 0, 1, 'Mozilla/5.0 (Linux; Android 7.1.2; M6 Note Build/N2G47H; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/66.0.3359.126 MQQBrowser/6.2 TBS/044904 Mobile Safari/537.36 V1_AND_SQ_8.1.5_1258_YYB_D QQ/8.1.5.4215 NetType/WIFI WebP/0.3.0 Pixel/1080 StatusBarHeight/66 SimpleUISwitch/0', '127.0.0.1', '内网IP', 'admin', '2019-10-26 17:18:26');
INSERT INTO `sys_log_login` VALUES ('1188340173061971970', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-27 14:22:30');
INSERT INTO `sys_log_login` VALUES ('1188698514258878466', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-28 14:06:25');
INSERT INTO `sys_log_login` VALUES ('1188781110078693379', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-28 19:34:38');
INSERT INTO `sys_log_login` VALUES ('1189063131300585475', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-29 14:15:17');
INSERT INTO `sys_log_login` VALUES ('1189064449851351043', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-29 14:20:31');
INSERT INTO `sys_log_login` VALUES ('1189065382706503682', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-29 14:24:14');
INSERT INTO `sys_log_login` VALUES ('1189710395043962883', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-31 09:07:17');
INSERT INTO `sys_log_login` VALUES ('1189760451411402754', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-31 12:26:11');
INSERT INTO `sys_log_login` VALUES ('1189761750844530690', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-31 12:31:21');
INSERT INTO `sys_log_login` VALUES ('1189874584018444291', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-10-31 19:59:42');
INSERT INTO `sys_log_login` VALUES ('1190142593781948419', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-01 13:44:41');
INSERT INTO `sys_log_login` VALUES ('1190157287771037698', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-01 14:43:04');
INSERT INTO `sys_log_login` VALUES ('1190176439365754883', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-01 15:59:10');
INSERT INTO `sys_log_login` VALUES ('1190191932050989059', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.75 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-01 17:00:44');
INSERT INTO `sys_log_login` VALUES ('1190192706881544195', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-01 17:03:49');
INSERT INTO `sys_log_login` VALUES ('1190197994611236867', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-01 17:24:49');
INSERT INTO `sys_log_login` VALUES ('1190198056854708226', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-01 17:25:04');
INSERT INTO `sys_log_login` VALUES ('1190199191225196546', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.116 Safari/537.36 QBCore/4.0.1252.400 QQBrowser/9.0.2524.400', '127.0.0.1', '内网IP', 'admin', '2019-11-01 17:29:35');
INSERT INTO `sys_log_login` VALUES ('1190204599989919747', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-01 17:51:04');
INSERT INTO `sys_log_login` VALUES ('1190249763701743619', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-01 20:50:32');
INSERT INTO `sys_log_login` VALUES ('1190272137574703107', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-01 22:19:26');
INSERT INTO `sys_log_login` VALUES ('1190504657830502403', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-02 13:43:24');
INSERT INTO `sys_log_login` VALUES ('1190551163837046787', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-02 16:48:11');
INSERT INTO `sys_log_login` VALUES ('1191174110519975938', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-04 10:03:34');
INSERT INTO `sys_log_login` VALUES ('1191174754165284866', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-04 10:06:07');
INSERT INTO `sys_log_login` VALUES ('1191178411871002627', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-04 10:20:39');
INSERT INTO `sys_log_login` VALUES ('1191179217458388995', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-04 10:23:51');
INSERT INTO `sys_log_login` VALUES ('1191180633946152963', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-04 10:29:29');
INSERT INTO `sys_log_login` VALUES ('1191190966832160770', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-04 11:10:32');
INSERT INTO `sys_log_login` VALUES ('1191194524730220546', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-04 11:24:41');
INSERT INTO `sys_log_login` VALUES ('1191195014075473923', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-04 11:26:37');
INSERT INTO `sys_log_login` VALUES ('1191248704127852546', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-04 14:59:58');
INSERT INTO `sys_log_login` VALUES ('1191340614939009027', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-04 21:05:11');
INSERT INTO `sys_log_login` VALUES ('1191504826659201027', 0, 1, 'Mozilla/5.0 (Linux; U; Android 9; zh-cn; Mi Note 3 Build/PKQ1.181007.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/71.0.3578.141 Mobile Safari/537.36 XiaoMi/MiuiBrowser/11.1.7', '127.0.0.1', '内网IP', 'admin', '2019-11-05 07:57:42');
INSERT INTO `sys_log_login` VALUES ('1191532716834643970', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.181 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-05 09:48:32');
INSERT INTO `sys_log_login` VALUES ('1191533214455259138', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-05 09:50:31');
INSERT INTO `sys_log_login` VALUES ('1191542068631003138', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-05 10:25:42');
INSERT INTO `sys_log_login` VALUES ('1191544228513013762', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.75 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-05 10:34:17');
INSERT INTO `sys_log_login` VALUES ('1191596857578446850', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-05 14:03:24');
INSERT INTO `sys_log_login` VALUES ('1191620944681984002', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-05 15:39:07');
INSERT INTO `sys_log_login` VALUES ('1191645090195398659', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-05 17:15:04');
INSERT INTO `sys_log_login` VALUES ('1192020011106918402', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-06 18:04:52');
INSERT INTO `sys_log_login` VALUES ('1192073019379376131', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-06 21:35:30');
INSERT INTO `sys_log_login` VALUES ('1192101757668253698', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-06 23:29:42');
INSERT INTO `sys_log_login` VALUES ('1192267342410637314', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-07 10:27:40');
INSERT INTO `sys_log_login` VALUES ('1192268822563741699', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-07 10:33:33');
INSERT INTO `sys_log_login` VALUES ('1192337154121883651', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-07 15:05:05');
INSERT INTO `sys_log_login` VALUES ('1192361357495721986', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-07 16:41:15');
INSERT INTO `sys_log_login` VALUES ('1192470375417470978', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-07 23:54:27');
INSERT INTO `sys_log_login` VALUES ('1192617832264720387', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-08 09:40:24');
INSERT INTO `sys_log_login` VALUES ('1192619805152075778', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-08 09:48:14');
INSERT INTO `sys_log_login` VALUES ('1192634519613562883', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-08 10:46:42');
INSERT INTO `sys_log_login` VALUES ('1192644172112158723', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-08 11:25:04');
INSERT INTO `sys_log_login` VALUES ('1193253084641320962', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-10 03:44:40');
INSERT INTO `sys_log_login` VALUES ('1193258319644418051', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-10 04:05:28');
INSERT INTO `sys_log_login` VALUES ('1193260561894170627', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36 Edge/18.18362', '127.0.0.1', '内网IP', 'admin', '2019-11-10 04:14:22');
INSERT INTO `sys_log_login` VALUES ('1193489351408836611', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3732.400 QQBrowser/10.5.3819.400', '127.0.0.1', '内网IP', 'admin', '2019-11-10 19:23:30');
INSERT INTO `sys_log_login` VALUES ('1193489529817751555', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3732.400 QQBrowser/10.5.3819.400', '127.0.0.1', '内网IP', 'admin', '2019-11-10 19:24:13');
INSERT INTO `sys_log_login` VALUES ('1193718602733150210', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-11 10:34:28');
INSERT INTO `sys_log_login` VALUES ('1193811748821360642', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-11 16:44:36');
INSERT INTO `sys_log_login` VALUES ('1193908054147424258', 0, 1, 'Mozilla/5.0 (Linux; Android 9; VTR-AL00 Build/HUAWEIVTR-AL00; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/66.0.3359.126 MQQBrowser/6.2 TBS/045008 Mobile Safari/537.36 MMWEBID/3333 MicroMessenger/7.0.8.1540(0x27000834) Process/tools NetType/WIFI Language/zh_CN ABI/arm64', '127.0.0.1', '内网IP', 'admin', '2019-11-11 23:07:17');
INSERT INTO `sys_log_login` VALUES ('1194050887726620675', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0', '127.0.0.1', '内网IP', 'admin', '2019-11-12 08:34:51');
INSERT INTO `sys_log_login` VALUES ('1194177397728960514', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-12 16:57:33');
INSERT INTO `sys_log_login` VALUES ('1194256113062600707', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36 Edge/18.18362', '127.0.0.1', '内网IP', 'admin', '2019-11-12 22:10:20');
INSERT INTO `sys_log_login` VALUES ('1194271193414197250', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-12 23:10:16');
INSERT INTO `sys_log_login` VALUES ('1194413894692462595', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-13 08:37:18');
INSERT INTO `sys_log_login` VALUES ('1194415867021975555', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-13 08:45:09');
INSERT INTO `sys_log_login` VALUES ('1194440595459760131', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-13 10:23:24');
INSERT INTO `sys_log_login` VALUES ('1194471509510283266', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-13 12:26:15');
INSERT INTO `sys_log_login` VALUES ('1194515135439265795', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-13 15:19:36');
INSERT INTO `sys_log_login` VALUES ('1194516807116873731', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-13 15:26:15');
INSERT INTO `sys_log_login` VALUES ('1194780757481971715', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3732.400 QQBrowser/10.5.3819.400', '127.0.0.1', '内网IP', 'admin', '2019-11-14 08:55:05');
INSERT INTO `sys_log_login` VALUES ('1194900515577618435', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-14 16:50:58');
INSERT INTO `sys_log_login` VALUES ('1195453251348029442', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-16 05:27:20');
INSERT INTO `sys_log_login` VALUES ('1195874955153072131', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0', '127.0.0.1', '内网IP', 'admin', '2019-11-17 09:23:02');
INSERT INTO `sys_log_login` VALUES ('1195876086948257795', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-17 09:27:32');
INSERT INTO `sys_log_login` VALUES ('1195954097588494338', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-17 14:37:31');
INSERT INTO `sys_log_login` VALUES ('1195970634957414402', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.181 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-17 15:43:14');
INSERT INTO `sys_log_login` VALUES ('1196396268779167746', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-18 19:54:33');
INSERT INTO `sys_log_login` VALUES ('1196592047615598594', 0, 1, 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-19 08:52:30');
INSERT INTO `sys_log_login` VALUES ('1196605134699716610', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-19 09:44:31');
INSERT INTO `sys_log_login` VALUES ('1196624253025214467', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-19 11:00:29');
INSERT INTO `sys_log_login` VALUES ('1196676371354443779', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-19 14:27:35');
INSERT INTO `sys_log_login` VALUES ('1196767498652835842', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-19 20:29:41');
INSERT INTO `sys_log_login` VALUES ('1196768029693665283', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:70.0) Gecko/20100101 Firefox/70.0', '127.0.0.1', '内网IP', 'admin', '2019-11-19 20:31:48');
INSERT INTO `sys_log_login` VALUES ('1196970810341810179', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-20 09:57:34');
INSERT INTO `sys_log_login` VALUES ('1196983851393441795', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3947.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-20 10:49:24');
INSERT INTO `sys_log_login` VALUES ('1196996152028782594', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-20 11:38:16');
INSERT INTO `sys_log_login` VALUES ('1197016557074472963', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0', '127.0.0.1', '内网IP', 'admin', '2019-11-20 12:59:21');
INSERT INTO `sys_log_login` VALUES ('1197040738705039362', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-20 14:35:27');
INSERT INTO `sys_log_login` VALUES ('1197152544706486274', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-20 21:59:43');
INSERT INTO `sys_log_login` VALUES ('1197412392090165251', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-21 15:12:16');
INSERT INTO `sys_log_login` VALUES ('1197465814533365763', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-21 18:44:33');
INSERT INTO `sys_log_login` VALUES ('1197856572432146434', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-22 20:37:17');
INSERT INTO `sys_log_login` VALUES ('1197874430616756227', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-22 21:48:14');
INSERT INTO `sys_log_login` VALUES ('1198160940113027075', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-23 16:46:44');
INSERT INTO `sys_log_login` VALUES ('1198168585142231043', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-23 17:17:06');
INSERT INTO `sys_log_login` VALUES ('1198258245432467459', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.157 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-23 23:13:23');
INSERT INTO `sys_log_login` VALUES ('1198456825933946882', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-24 12:22:28');
INSERT INTO `sys_log_login` VALUES ('1198484300441280515', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-24 14:11:39');
INSERT INTO `sys_log_login` VALUES ('1198504934655352834', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-24 15:33:38');
INSERT INTO `sys_log_login` VALUES ('1198605797411479554', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-24 22:14:26');
INSERT INTO `sys_log_login` VALUES ('1198793303058767874', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-25 10:39:31');
INSERT INTO `sys_log_login` VALUES ('1198948668052299779', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-25 20:56:53');
INSERT INTO `sys_log_login` VALUES ('1198973312373317635', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-25 22:34:48');
INSERT INTO `sys_log_login` VALUES ('1199005981404520450', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-26 00:44:37');
INSERT INTO `sys_log_login` VALUES ('1199135237384134658', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3314.0 Safari/537.36 SE 2.X MetaSr 1.0', '127.0.0.1', '内网IP', 'admin', '2019-11-26 09:18:14');
INSERT INTO `sys_log_login` VALUES ('1199177249441406979', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-26 12:05:11');
INSERT INTO `sys_log_login` VALUES ('1199194647104020483', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-26 13:14:18');
INSERT INTO `sys_log_login` VALUES ('1199231733123211267', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3314.0 Safari/537.36 SE 2.X MetaSr 1.0', '127.0.0.1', '内网IP', 'admin', '2019-11-26 15:41:40');
INSERT INTO `sys_log_login` VALUES ('1199234379213135874', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-26 15:52:11');
INSERT INTO `sys_log_login` VALUES ('1199234496062251011', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-26 15:52:39');
INSERT INTO `sys_log_login` VALUES ('1199235513365520387', 0, 1, 'Opera/9.80 (Windows NT 6.0) Presto/2.12.388 Version/12.14', '127.0.0.1', '内网IP', 'admin', '2019-11-26 15:56:42');
INSERT INTO `sys_log_login` VALUES ('1199252851942973443', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0', '127.0.0.1', '内网IP', 'admin', '2019-11-26 17:05:36');
INSERT INTO `sys_log_login` VALUES ('1199271509142495234', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-26 18:19:44');
INSERT INTO `sys_log_login` VALUES ('1199350552680423426', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-26 23:33:49');
INSERT INTO `sys_log_login` VALUES ('1199488802615156738', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-27 08:43:11');
INSERT INTO `sys_log_login` VALUES ('1199511044682113026', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-27 10:11:34');
INSERT INTO `sys_log_login` VALUES ('1199522539511963651', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-27 10:57:14');
INSERT INTO `sys_log_login` VALUES ('1199558686497792002', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0', '127.0.0.1', '内网IP', 'admin', '2019-11-27 13:20:52');
INSERT INTO `sys_log_login` VALUES ('1199568517317222402', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-27 13:59:56');
INSERT INTO `sys_log_login` VALUES ('1199887820314861570', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0', '127.0.0.1', '内网IP', 'admin', '2019-11-28 11:08:44');
INSERT INTO `sys_log_login` VALUES ('1199928212108304386', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0', '127.0.0.1', '内网IP', 'admin', '2019-11-28 13:49:14');
INSERT INTO `sys_log_login` VALUES ('1199935627834908674', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-28 14:18:42');
INSERT INTO `sys_log_login` VALUES ('1199963883103543298', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-28 16:10:59');
INSERT INTO `sys_log_login` VALUES ('1200058041302474755', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-28 22:25:08');
INSERT INTO `sys_log_login` VALUES ('1200073844835966978', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-28 23:27:56');
INSERT INTO `sys_log_login` VALUES ('1200232226301632515', 0, 1, 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-29 09:57:17');
INSERT INTO `sys_log_login` VALUES ('1200233381408759810', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:70.0) Gecko/20100101 Firefox/70.0', '127.0.0.1', '内网IP', 'admin', '2019-11-29 10:01:52');
INSERT INTO `sys_log_login` VALUES ('1200239622629580803', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-29 10:26:40');
INSERT INTO `sys_log_login` VALUES ('1200243178233356291', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-29 10:40:48');
INSERT INTO `sys_log_login` VALUES ('1200246638186029059', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-29 10:54:33');
INSERT INTO `sys_log_login` VALUES ('1200302056908218370', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.80 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-29 14:34:46');
INSERT INTO `sys_log_login` VALUES ('1200363219142533122', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-29 18:37:48');
INSERT INTO `sys_log_login` VALUES ('1200617134131994627', 0, 1, 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_1_3 like Mac OS X; zh-CN) AppleWebKit/537.51.1 (KHTML, like Gecko) Mobile/17A878 UCBrowser/12.7.4.1243 Mobile  AliApp(TUnionSDK/0.1.20.3)', '122.192.14.118', '中国|江苏省|南京市|联通', 'admin', '2019-11-30 11:26:46');
INSERT INTO `sys_log_login` VALUES ('1200699456365748227', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-30 16:53:53');
INSERT INTO `sys_log_login` VALUES ('1200699456445440002', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-30 16:53:53');
INSERT INTO `sys_log_login` VALUES ('1200713104731627521', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-30 17:48:07');
INSERT INTO `sys_log_login` VALUES ('1200785866972160003', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-11-30 22:37:15');
INSERT INTO `sys_log_login` VALUES ('1201128206790254594', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-01 21:17:35');
INSERT INTO `sys_log_login` VALUES ('1201307668643274755', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-02 09:10:42');
INSERT INTO `sys_log_login` VALUES ('1201310075880169474', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.109 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-02 09:20:16');
INSERT INTO `sys_log_login` VALUES ('1201407102513274882', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-02 15:45:49');
INSERT INTO `sys_log_login` VALUES ('1201410359776206850', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.181 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-02 15:58:46');
INSERT INTO `sys_log_login` VALUES ('1201522301362724866', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3947.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-02 23:23:35');
INSERT INTO `sys_log_login` VALUES ('1201740361076006914', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-03 13:50:04');
INSERT INTO `sys_log_login` VALUES ('1201746248737972226', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-03 14:13:28');
INSERT INTO `sys_log_login` VALUES ('1201754582408978434', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-03 14:46:35');
INSERT INTO `sys_log_login` VALUES ('1201766352880099330', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-03 15:33:21');
INSERT INTO `sys_log_login` VALUES ('1201787931848564738', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-03 16:59:06');
INSERT INTO `sys_log_login` VALUES ('1201788238661902338', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-03 17:00:19');
INSERT INTO `sys_log_login` VALUES ('1201789206556270594', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-03 17:04:10');
INSERT INTO `sys_log_login` VALUES ('1201789420100870147', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-03 17:05:01');
INSERT INTO `sys_log_login` VALUES ('1202085938934538243', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-04 12:43:16');
INSERT INTO `sys_log_login` VALUES ('1202141050608508930', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-04 16:22:16');
INSERT INTO `sys_log_login` VALUES ('1202250061467049986', 0, 1, 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_1_1 like Mac OS X; zh-CN) AppleWebKit/537.51.1 (KHTML, like Gecko) Mobile/17A854 UCBrowser/12.7.1.1240 Mobile  AliApp(TUnionSDK/0.1.20.3)', '183.193.37.236', '中国|上海|上海市|移动', 'admin', '2019-12-04 23:35:26');
INSERT INTO `sys_log_login` VALUES ('1202524012877406210', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-05 17:44:01');
INSERT INTO `sys_log_login` VALUES ('1202559507737042947', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-05 20:05:04');
INSERT INTO `sys_log_login` VALUES ('1202847590978117635', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-06 15:09:48');
INSERT INTO `sys_log_login` VALUES ('1203129490053488643', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-07 09:49:58');
INSERT INTO `sys_log_login` VALUES ('1203366951912431618', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-08 01:33:33');
INSERT INTO `sys_log_login` VALUES ('1203515501195517954', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-08 11:23:50');
INSERT INTO `sys_log_login` VALUES ('1203658881976197123', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-08 20:53:35');
INSERT INTO `sys_log_login` VALUES ('1203968708183023618', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-09 17:24:43');
INSERT INTO `sys_log_login` VALUES ('1204094461608419331', 0, 1, 'Mozilla/5.0 (Linux; Android 9; MI 6 Build/PQ3A.190801.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/77.0.3865.116 Mobile Safari/537.36 Nga_Official/80025', '127.0.0.1', '内网IP', 'admin', '2019-12-10 01:44:25');
INSERT INTO `sys_log_login` VALUES ('1204595554109054979', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-11 10:55:35');
INSERT INTO `sys_log_login` VALUES ('1204666619413880835', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.80 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-11 15:37:58');
INSERT INTO `sys_log_login` VALUES ('1204685934632591362', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-11 16:54:43');
INSERT INTO `sys_log_login` VALUES ('1205000479100067842', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.181 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-12 13:44:37');
INSERT INTO `sys_log_login` VALUES ('1205333684793597954', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-13 11:48:39');
INSERT INTO `sys_log_login` VALUES ('1205336282800021507', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-13 11:58:59');
INSERT INTO `sys_log_login` VALUES ('1205381920694689795', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-13 15:00:19');
INSERT INTO `sys_log_login` VALUES ('1205499344731463682', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.79 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-13 22:46:56');
INSERT INTO `sys_log_login` VALUES ('1205499344815349763', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.79 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-13 22:46:56');
INSERT INTO `sys_log_login` VALUES ('1205504631840399362', 0, 1, 'Mozilla/5.0 (iPhone; CPU iPhone OS 12_4_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 QQ/8.2.0.617 V1_IPH_SQ_8.2.0_1_APP_A Pixel/828 MiniAppEnable Core/WKWebView Device/Apple(iPhone XR) NetType/WIFI QBWebViewType/1 WKType/1', '127.0.0.1', '内网IP', 'admin', '2019-12-13 23:07:56');
INSERT INTO `sys_log_login` VALUES ('1205760227617497091', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3741.400 QQBrowser/10.5.3863.400', '127.0.0.1', '内网IP', 'admin', '2019-12-14 16:03:35');
INSERT INTO `sys_log_login` VALUES ('1206196983273840642', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-15 20:59:06');
INSERT INTO `sys_log_login` VALUES ('1206474891015970818', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-16 15:23:24');
INSERT INTO `sys_log_login` VALUES ('1206849067841183746', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-17 16:10:15');
INSERT INTO `sys_log_login` VALUES ('1206862577371406339', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-17 17:03:56');
INSERT INTO `sys_log_login` VALUES ('1206873029153349635', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-17 17:45:27');
INSERT INTO `sys_log_login` VALUES ('1207100536339259395', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-18 08:49:29');
INSERT INTO `sys_log_login` VALUES ('1207125324508127235', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.87 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-18 10:27:59');
INSERT INTO `sys_log_login` VALUES ('1207229977258319875', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.26 Safari/537.36 Core/1.63.6788.400 QQBrowser/10.3.2864.400', '127.0.0.1', '内网IP', 'task', '2019-12-18 17:23:50');
INSERT INTO `sys_log_login` VALUES ('1207462377456361475', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-19 08:47:19');
INSERT INTO `sys_log_login` VALUES ('1207462953191694339', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-19 08:49:36');
INSERT INTO `sys_log_login` VALUES ('1207538062971592706', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-19 13:48:04');
INSERT INTO `sys_log_login` VALUES ('1207582426951278594', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-19 16:44:21');
INSERT INTO `sys_log_login` VALUES ('1207592867861585923', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0', '127.0.0.1', '内网IP', 'task', '2019-12-19 17:25:50');
INSERT INTO `sys_log_login` VALUES ('1207625404864487427', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0', '127.0.0.1', '内网IP', 'task', '2019-12-19 19:35:08');
INSERT INTO `sys_log_login` VALUES ('1207664219637374978', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.79 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-19 22:09:22');
INSERT INTO `sys_log_login` VALUES ('1207908584196628483', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-20 14:20:23');
INSERT INTO `sys_log_login` VALUES ('1207946512243318786', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-20 16:51:06');
INSERT INTO `sys_log_login` VALUES ('1207970620381290499', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-20 18:26:54');
INSERT INTO `sys_log_login` VALUES ('1208248666799693826', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-21 12:51:45');
INSERT INTO `sys_log_login` VALUES ('1208709958341713922', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.1.2 Safari/605.1.15', '127.0.0.1', '内网IP', 'task', '2019-12-22 19:24:45');
INSERT INTO `sys_log_login` VALUES ('1208979914660732930', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-23 13:17:28');
INSERT INTO `sys_log_login` VALUES ('1208995631577653250', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-23 14:19:55');
INSERT INTO `sys_log_login` VALUES ('1209005543053549571', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-23 14:59:18');
INSERT INTO `sys_log_login` VALUES ('1209020715625308162', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-23 15:59:36');
INSERT INTO `sys_log_login` VALUES ('1209031967932112899', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-23 16:44:19');
INSERT INTO `sys_log_login` VALUES ('1209376473453912067', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.79 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-24 15:33:15');
INSERT INTO `sys_log_login` VALUES ('1209397293635035139', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-24 16:55:59');
INSERT INTO `sys_log_login` VALUES ('1209403426777030658', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-24 17:20:21');
INSERT INTO `sys_log_login` VALUES ('1209641072593952771', 0, 1, 'Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-25 09:04:40');
INSERT INTO `sys_log_login` VALUES ('1209641127442866178', 0, 1, 'Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-25 09:04:53');
INSERT INTO `sys_log_login` VALUES ('1209641185529782275', 0, 1, 'Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-25 09:05:07');
INSERT INTO `sys_log_login` VALUES ('1209641253271986179', 0, 1, 'Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-25 09:05:23');
INSERT INTO `sys_log_login` VALUES ('1209643748761231362', 0, 1, 'Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-25 09:15:18');
INSERT INTO `sys_log_login` VALUES ('1209721007635390467', 0, 1, 'Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-25 14:22:18');
INSERT INTO `sys_log_login` VALUES ('1209752695237206019', 0, 1, 'Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-25 16:28:13');
INSERT INTO `sys_log_login` VALUES ('1209760049303347202', 0, 1, 'Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-25 16:57:27');
INSERT INTO `sys_log_login` VALUES ('1209825782293028866', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-25 21:18:39');
INSERT INTO `sys_log_login` VALUES ('1209835117131816963', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-25 21:55:44');
INSERT INTO `sys_log_login` VALUES ('1209970522795761666', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-26 06:53:47');
INSERT INTO `sys_log_login` VALUES ('1210221696526540802', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.80 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-26 23:31:52');
INSERT INTO `sys_log_login` VALUES ('1210375137643159555', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-27 09:41:35');
INSERT INTO `sys_log_login` VALUES ('1210451967733620738', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36', '127.0.0.1', '内网IP', 'task', '2019-12-27 14:46:53');
INSERT INTO `sys_log_login` VALUES ('1210462274820464643', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-27 15:27:50');
INSERT INTO `sys_log_login` VALUES ('1210463565630103555', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0', '127.0.0.1', '内网IP', 'admin', '2019-12-27 15:32:58');
INSERT INTO `sys_log_login` VALUES ('1210483904447733763', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-27 16:53:47');
INSERT INTO `sys_log_login` VALUES ('1210909531751538690', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.87 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-28 21:05:05');
INSERT INTO `sys_log_login` VALUES ('1211494391549485059', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-30 11:49:06');
INSERT INTO `sys_log_login` VALUES ('1211538984349425667', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-30 14:46:18');
INSERT INTO `sys_log_login` VALUES ('1211860274008514563', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-31 12:02:59');
INSERT INTO `sys_log_login` VALUES ('1211876487262593027', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3676.400 QQBrowser/10.4.3505.400', '127.0.0.1', '内网IP', 'admin', '2019-12-31 13:07:25');
INSERT INTO `sys_log_login` VALUES ('1211947678857912322', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2019-12-31 17:50:18');
INSERT INTO `sys_log_login` VALUES ('1212316801941069826', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2020-01-01 18:17:04');
INSERT INTO `sys_log_login` VALUES ('1212556574400143362', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2020-01-02 10:09:50');
INSERT INTO `sys_log_login` VALUES ('1212556993981538306', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'admin', '2020-01-02 10:11:30');
INSERT INTO `sys_log_login` VALUES ('1212619052530229251', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-02 14:18:06');
INSERT INTO `sys_log_login` VALUES ('1212623760875544578', 0, 1, 'Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-02 14:36:49');
INSERT INTO `sys_log_login` VALUES ('1212623874813812738', 0, 1, 'Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-02 14:37:16');
INSERT INTO `sys_log_login` VALUES ('1212627381264539650', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-02 14:51:12');
INSERT INTO `sys_log_login` VALUES ('1212642554431889410', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.181 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-02 15:51:29');
INSERT INTO `sys_log_login` VALUES ('1212647885702651906', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.181 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-02 16:12:41');
INSERT INTO `sys_log_login` VALUES ('1212676733550944258', 0, 1, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-02 18:07:18');
INSERT INTO `sys_log_login` VALUES ('1212901713391869954', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-03 09:01:18');
INSERT INTO `sys_log_login` VALUES ('1212988096341041155', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-03 14:44:33');
INSERT INTO `sys_log_login` VALUES ('1213019266432851971', 0, 1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_2) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.4 Safari/605.1.15', '127.0.0.1', '内网IP', 'ht', '2020-01-03 16:48:25');
INSERT INTO `sys_log_login` VALUES ('1213041661768065026', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-03 18:17:24');
INSERT INTO `sys_log_login` VALUES ('1213053987552452611', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-03 19:06:23');
INSERT INTO `sys_log_login` VALUES ('1213790775367655426', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:71.0) Gecko/20100101 Firefox/71.0', '127.0.0.1', '内网IP', 'ht', '2020-01-05 19:54:07');
INSERT INTO `sys_log_login` VALUES ('1214032489391022083', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-06 11:54:36');
INSERT INTO `sys_log_login` VALUES ('1214083589708144643', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-06 15:17:39');
INSERT INTO `sys_log_login` VALUES ('1214084344657698819', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-06 15:20:39');
INSERT INTO `sys_log_login` VALUES ('1214084636115689475', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-06 15:21:49');
INSERT INTO `sys_log_login` VALUES ('1214087622124593154', 0, 1, 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-06 15:33:40');
INSERT INTO `sys_log_login` VALUES ('1214123290959765507', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', '127.0.0.1', '内网IP', 'ht', '2020-01-06 17:55:25');
INSERT INTO `sys_log_login` VALUES ('1214161318770876417', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', NULL, 'admin', NULL);
INSERT INTO `sys_log_login` VALUES ('1214173450623213570', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', NULL, 'admin', NULL);
INSERT INTO `sys_log_login` VALUES ('1214173845437222913', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', NULL, 'admin', NULL);
INSERT INTO `sys_log_login` VALUES ('1214177812229566465', 0, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', NULL, 'admin', NULL);
...
-- ----------------------------
INSERT INTO `sys_log_operation` VALUES ('1178228622802731009', 'admin', '修改密码', '/quickd/sys/user/password', 'POST', '{\"newPassword\":\"VFZSSmVrNUVWVEpPZW1jOQ==\",\"password\":\"VFZSSmVrNUVWVEk9\"}', 90, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-09-29 16:42:49');
INSERT INTO `sys_log_operation` VALUES ('1178229310005886978', 'admin', '修改密码', '/quickd/sys/user/password', 'POST', '{\"newPassword\":\"VFZSSmVrNUVWVEpPZW1jOQ==\",\"password\":\"VFZSSmVrNUVWVEk9\"}', 92778, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-09-29 16:45:33');
INSERT INTO `sys_log_operation` VALUES ('1178229347809148930', 'admin', '修改密码', '/quickd/sys/user/password', 'POST', '{\"newPassword\":\"VFZSSmVrNUVWVEpPZW1jOQ==\",\"password\":\"VFZSSmVrNUVWVEk9\"}', 9000, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-09-29 16:45:42');
INSERT INTO `sys_log_operation` VALUES ('1178229347809148932', 'admin', '修改密码', '/quickd/sys/user/password', 'POST', '{\"newPassword\":\"VFZSSmVrNUVWVEpPZW1jOQ==\",\"password\":\"VFZSSmVrNUVWVEk9\"}', 2251, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-09-29 16:45:42');
INSERT INTO `sys_log_operation` VALUES ('1178230532398067714', 'admin', '修改密码', '/quickd/sys/user/password', 'POST', '{\"newPassword\":\"VFZSSmVrNUVWVEpPZW1jOQ==\",\"password\":\"VFZSSmVrNUVWVEk9\"}', 3837, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-09-29 16:50:24');
INSERT INTO `sys_log_operation` VALUES ('1178231300698062851', 'admin', '修改密码', '/quickd/sys/user/password', 'POST', '{\"newPassword\":\"VFZSSmVrNUVWVEpPZW1jOQ==\",\"password\":\"VFZSSmVrNUVWVEk9\"}', 2867, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-09-29 16:53:27');
INSERT INTO `sys_log_operation` VALUES ('1183629234320400387', 'admin', '修改', '/quickd/sys/menu', 'PUT', '{\"component\":\"modules/sys/config/index\",\"hidden\":0,\"icon\":\"user\",\"id\":\"1090\",\"isRoute\":true,\"isUniapp\":false,\"name\":\"系统配置\",\"permsType\":\"0\",\"pid\":\"1\",\"ruleFlag\":0,\"sort\":300,\"type\":1,\"url\":\"setting\"}', 63, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-10-14 14:22:55');
INSERT INTO `sys_log_operation` VALUES ('1183629263521144834', 'admin', '修改', '/quickd/sys/menu', 'PUT', '{\"component\":\"modules/sys/log/log-login\",\"hidden\":0,\"icon\":\"list\",\"id\":\"5\",\"isRoute\":true,\"isUniapp\":false,\"name\":\"登录日志\",\"permsType\":\"0\",\"pid\":\"18\",\"ruleFlag\":0,\"sort\":10,\"type\":1,\"url\":\"log-login\"}', 7, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-10-14 14:23:02');
INSERT INTO `sys_log_operation` VALUES ('1183929128255971330', 'admin', '修改', '/quickd/sys/role', 'PUT', '{\"createTime\":1566687348000,\"id\":\"1\",\"remarks\":\"超级管理员\",\"roleCode\":\"admin\",\"roleName\":\"超级管理员\"}', 26, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3732.400 QQBrowser/10.5.3819.400', '127.0.0.1', '内网IP', 1, 'admin', '2019-10-15 10:14:35');
INSERT INTO `sys_log_operation` VALUES ('1183930485067177987', 'admin', '修改', '/quickd/sys/role', 'PUT', '{\"createTime\":1566687348000,\"id\":\"2\",\"remarks\":\"用于测试菜单与权限\",\"roleCode\":\"common\",\"roleName\":\"普通用户\"}', 20, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3732.400 QQBrowser/10.5.3819.400', '127.0.0.1', '内网IP', 1, 'admin', '2019-10-15 10:19:59');
INSERT INTO `sys_log_operation` VALUES ('1183930544861175810', 'admin', '修改', '/quickd/sys/role', 'PUT', '{\"createTime\":1569748197000,\"id\":\"3\",\"remarks\":\"普通管理员级别为2，使用该角色新增用户时只能赋予比普通管理员级别低的角色\",\"roleCode\":\"ladmin\",\"roleName\":\"普通管理员\"}', 5, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3732.400 QQBrowser/10.5.3819.400', '127.0.0.1', '内网IP', 1, 'admin', '2019-10-15 10:20:13');
INSERT INTO `sys_log_operation` VALUES ('1183932457069535235', 'admin', '保存', '/quickd/sys/schedule', 'POST', '{\"beanName\":\"demo\",\"cronExpression\":\"0 0 12**？\",\"params\":\"123\",\"remark\":\"demo\",\"status\":0}', 22, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.25 Safari/537.36 Core/1.70.3732.400 QQBrowser/10.5.3819.400', '127.0.0.1', '内网IP', 1, 'admin', '2019-10-15 10:27:49');
INSERT INTO `sys_log_operation` VALUES ('1183955379012198403', 'admin', '根据一组id删除数据', '/quickd/sys/job', 'DELETE', '[\"10\"]', 16, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-10-15 11:58:54');
INSERT INTO `sys_log_operation` VALUES ('1183955483865604099', 'admin', '根据一组id删除数据', '/quickd/sys/job', 'DELETE', '[\"8\"]', 5, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-10-15 11:59:19');
INSERT INTO `sys_log_operation` VALUES ('1184111744108158979', 'admin', '根据一组id删除数据', '/quickd/sys/job', 'DELETE', '[\"11\"]', 3, 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-10-15 22:20:14');
INSERT INTO `sys_log_operation` VALUES ('1186899454350811138', 'admin', '根据一组id删除数据', '/quickd/sys/job', 'DELETE', '[\"2\"]', 3, 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-10-23 14:57:36');
INSERT INTO `sys_log_operation` VALUES ('1190167397142585346', NULL, '保存', '/quickd/sys/notice', 'POST', '{\"createBy\":\"\",\"id\":\"\",\"msgCategory\":\"\",\"msgContent\":\"\",\"msgType\":\"\",\"priority\":\"\",\"sendStatus\":\"\",\"sender\":\"\",\"titile\":\"\",\"updateBy\":\"\",\"userIds\":\"\",\"version\":0}', 25, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.100 Safari/537.36', '127.0.0.1', '内网IP', 1, NULL, '2019-11-01 15:23:14');
INSERT INTO `sys_log_operation` VALUES ('1196049947580915715', NULL, '保存', '/quickd/gen/table', 'POST', '{\"className\":\"\",\"comments\":\"\",\"createBy\":\"\",\"description\":\"\",\"id\":\"\",\"name\":\"\",\"parentTable\":\"\",\"parentTableFk\":\"\"}', 39, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36', '127.0.0.1', '内网IP', 1, NULL, '2019-11-17 20:58:24');
INSERT INTO `sys_log_operation` VALUES ('1196984004342931458', 'admin', '保存', '/quickd/sys/schedule', 'POST', '{\"beanName\":\"test\",\"cronExpression\":\"\",\"params\":\"123\",\"remark\":\"\",\"status\":0}', 12, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3947.100 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-11-20 10:50:00');
INSERT INTO `sys_log_operation` VALUES ('1199234469571026947', 'admin', '修改密码', '/quickd/sys/user/password', 'POST', '{\"newPassword\":\"V1ZkU2RHRlhOSGc9\",\"password\":\"V1ZkU2RHRlhORDA9\"}', 2, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-11-26 15:52:33');
INSERT INTO `sys_log_operation` VALUES ('1199235658983366660', 'admin', '保存', '/quickd/sys/menu', 'POST', '{\"component\":\"Layout\",\"icon\":\"QQ\",\"name\":\"111\",\"permissions\":\"\",\"pid\":\"0\",\"sort\":0,\"type\":0,\"url\":\"11\"}', 12, 'Opera/9.80 (Windows NT 6.0) Presto/2.12.388 Version/12.14', '127.0.0.1', '内网IP', 1, 'admin', '2019-11-26 15:57:16');
INSERT INTO `sys_log_operation` VALUES ('1199235745465720834', 'admin', '根据一组id删除数据', '/quickd/sys/menu', 'DELETE', '[\"1199235658983366658\"]', 3, 'Opera/9.80 (Windows NT 6.0) Presto/2.12.388 Version/12.14', '127.0.0.1', '内网IP', 1, 'admin', '2019-11-26 15:57:37');
INSERT INTO `sys_log_operation` VALUES ('1200786014758461443', 'admin', '根据一组id删除数据', '/quickd/sys/user', 'DELETE', '[]', 0, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-11-30 22:37:50');
INSERT INTO `sys_log_operation` VALUES ('1202524329895485443', 'admin', '修改', '/quickd/sys/menu', 'PUT', '{\"component\":\"modules/sys/config/index\",\"hidden\":0,\"icon\":\"user\",\"id\":\"1090\",\"isRoute\":true,\"isUniapp\":false,\"name\":\"系统配置\",\"permsType\":\"0\",\"pid\":\"1\",\"ruleFlag\":0,\"sort\":300,\"type\":1,\"url\":\"setting\"}', 38, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-12-05 17:45:17');
INSERT INTO `sys_log_operation` VALUES ('1202524366302044163', 'admin', '修改', '/quickd/sys/menu', 'PUT', '{\"createTime\":1571111561000,\"hidden\":0,\"id\":\"1183953818039050243\",\"isRoute\":true,\"isUniapp\":false,\"name\":\"查看\",\"permissions\":\"onl:graphreport_item:page,onl:graphreport_item:info\",\"permsType\":\"0\",\"pid\":\"1183953818039050242\",\"ruleFlag\":0,\"sort\":1,\"type\":2}', 6, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2019-12-05 17:45:25');
INSERT INTO `sys_log_operation` VALUES ('1213042878808285187', 'admin', '保存', '/quickd/sys/dict', 'POST', '{\"description\":\"\"}', 28, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36', '127.0.0.1', '内网IP', 1, 'admin', '2020-01-03 18:22:14');
...
CREATE TABLE `sys_mail_log`  (
  `id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'id',
  `template_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '邮件模板ID',
  `mail_from` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '发送者',
  `mail_to` varchar(400) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '收件人',
  `mail_cc` varchar(400) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '抄送者',
  `subject` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '邮件主题',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '邮件正文',
  `status` tinyint(3) UNSIGNED NULL DEFAULT NULL COMMENT '发送状态  0：失败  1：成功',
  `remarks` varchar(500) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '备注信息',
  `is_delete` int(1) NULL DEFAULT NULL COMMENT '删除状态（0，正常，1已删除）',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `sys_mail_log` VALUES ('1184348518628438018', '1184343830478692355', '631079326@qq.com', '[\"631079326@qq.com\"]', '[\"631079326@qq.com\"]', '注册验证码', '<p>注册验证码：123456&nbsp;&nbsp;<br></p>', 0, NULL, 0);
INSERT INTO `sys_mail_log` VALUES ('1184350764657176578', '1184343830478692355', 'renrenio_test@163.com', '[\"631079326@qq.com\"]', NULL, '注册验证码', '<p>注册验证码：123456&nbsp;&nbsp;<br></p>', 1, NULL, 0);
INSERT INTO `sys_mail_log` VALUES ('1184350954319409155', '1184343830478692355', 'renrenio_test@163.com', '[\"631079326@qq.com\"]', '[\"631079326@qq.com\"]', '注册验证码', '<p>注册验证码：123456&nbsp;&nbsp;<br></p>', 1, NULL, 0);
...
CREATE TABLE `sys_mail_template`  (
  ...
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_user` bigint(64) NULL DEFAULT NULL COMMENT '更新者',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `remarks` varchar(500) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '备注信息',
  `is_deleted` int(1) NULL DEFAULT NULL COMMENT '删除状态（0，正常，1已删除）',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_create_time`(`create_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '邮件模板' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_mail_template
-- ----------------------------
INSERT INTO `sys_mail_template` VALUES ('1184343830478692355', '验证码模板', '注册验证码', '<p>注册验证码：${code}&nbsp;&nbsp;<br></p>', 1, NULL, '2019-10-16 13:42:28', NULL, NULL, NULL, 0);
...
INSERT INTO `sys_menu` VALUES ('1090', '1', '系统配置', 'setting', 'modules/sys/config/index', NULL, 1, NULL, '0', 300, NULL, 'user', 1, NULL, 0, NULL, 0, NULL, NULL, NULL, 'admin', '2019-12-05 17:45:17', '0', 0, NULL, 1);
...
INSERT INTO `sys_menu` VALUES ('1183953818039050243', '1183953818039050242', '查看', NULL, NULL, NULL, 2, 'onl:graphreport_item:page,onl:graphreport_item:info', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-10-15 11:52:41', 'admin', '2019-12-05 17:45:25', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1183953818039050244', '1183953818039050242', '新增', NULL, NULL, NULL, 2, 'onl:graphreport_item:save', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-10-15 11:52:41', 'system', '2019-10-15 11:52:41', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1183953818039050245', '1183953818039050242', '修改', NULL, NULL, NULL, 2, 'onl:graphreport_item:update', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-10-15 11:52:41', 'system', '2019-10-15 11:52:41', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1183953818039050246', '1183953818039050242', '删除', NULL, NULL, NULL, 2, 'onl:graphreport_item:delete', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-10-15 11:52:41', 'system', '2019-10-15 11:52:41', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1183953818039050247', '1183953818039050242', '导出', NULL, NULL, NULL, 2, 'onl:graphreport_item:export', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-10-15 11:52:41', 'system', '2019-10-15 11:52:41', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1199235658983366658', '0', '111', '11', 'Layout', NULL, 0, '', '0', 0, NULL, 'QQ', 1, NULL, 0, NULL, 0, NULL, 'admin', '2019-11-26 15:57:16', NULL, NULL, '1', 0, NULL, 1);
...
INSERT INTO `sys_menu` VALUES ('1207582751808512002', NULL, '业务表', 'gen/table', 'modules/gen/table', NULL, 1, NULL, '0', 15, NULL, 'dashboard', 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-19 16:45:38', 'system', '2019-12-19 16:45:38', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1207582751808512003', '1207582751808512002', '查看', NULL, NULL, NULL, 2, 'gen:table:page,gen:table:info', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-19 16:45:38', 'system', '2019-12-19 16:45:38', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1207582751808512004', '1207582751808512002', '新增', NULL, NULL, NULL, 2, 'gen:table:save', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-19 16:45:38', 'system', '2019-12-19 16:45:38', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1207582751808512005', '1207582751808512002', '修改', NULL, NULL, NULL, 2, 'gen:table:update', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-19 16:45:38', 'system', '2019-12-19 16:45:38', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1207582751808512006', '1207582751808512002', '删除', NULL, NULL, NULL, 2, 'gen:table:delete', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-19 16:45:38', 'system', '2019-12-19 16:45:38', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1207582751808512007', '1207582751808512002', '导出', NULL, NULL, NULL, 2, 'gen:table:export', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-19 16:45:38', 'system', '2019-12-19 16:45:38', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1210468033557913602', NULL, '业务表字段', 'gen/table_column', 'modules/gen/table_column', NULL, 1, NULL, '0', 15, NULL, 'dashboard', 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-27 15:50:43', 'system', '2019-12-27 15:50:43', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1210468033557913603', '1210468033557913602', '查看', NULL, NULL, NULL, 2, 'gen:table_column:page,gen:table_column:info', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-27 15:50:43', 'system', '2019-12-27 15:50:43', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1210468033557913604', '1210468033557913602', '新增', NULL, NULL, NULL, 2, 'gen:table_column:save', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-27 15:50:43', 'system', '2019-12-27 15:50:43', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1210468033557913605', '1210468033557913602', '修改', NULL, NULL, NULL, 2, 'gen:table_column:update', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-27 15:50:43', 'system', '2019-12-27 15:50:43', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1210468033557913606', '1210468033557913602', '删除', NULL, NULL, NULL, 2, 'gen:table_column:delete', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-27 15:50:43', 'system', '2019-12-27 15:50:43', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1210468033557913607', '1210468033557913602', '导出', NULL, NULL, NULL, 2, 'gen:table_column:export', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-27 15:50:43', 'system', '2019-12-27 15:50:43', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1211861397729665026', '1', '图表报告', 'onl/graphreport_head', 'modules/onl/graphreport_head', NULL, 1, NULL, '0', 15, NULL, 'view', 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-31 12:07:27', 'system', '2019-12-31 12:07:27', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1211861397729665027', '1211861397729665026', '查看', NULL, NULL, NULL, 2, 'onl:graphreport_head:page,onl:graphreport_head:info', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-31 12:07:27', 'system', '2019-12-31 12:07:27', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1211861397729665028', '1211861397729665026', '新增', NULL, NULL, NULL, 2, 'onl:graphreport_head:save', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-31 12:07:27', 'system', '2019-12-31 12:07:27', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1211861397729665029', '1211861397729665026', '修改', NULL, NULL, NULL, 2, 'onl:graphreport_head:update', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-31 12:07:27', 'system', '2019-12-31 12:07:27', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1211861397729665030', '1211861397729665026', '删除', NULL, NULL, NULL, 2, 'onl:graphreport_head:delete', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-31 12:07:27', 'system', '2019-12-31 12:07:27', '0', 0, NULL, 1);
INSERT INTO `sys_menu` VALUES ('1211861397729665031', '1211861397729665026', '导出', NULL, NULL, NULL, 2, 'onl:graphreport_head:export', '0', 1, NULL, NULL, 1, NULL, 0, NULL, 0, NULL, 'system', '2019-12-31 12:07:27', 'system', '2019-12-31 12:07:27', '0', 0, NULL, 1);
...
INSERT INTO `sys_menu` VALUES ('29', '28', '单一图表设计', 'single-chart', 'modules/report/single-chart', NULL, 1, NULL, '0', 15, NULL, 'chart', 1, NULL, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, '0', 0, NULL, 1);
...
INSERT INTO `sys_menu` VALUES ('30', '28', '混合图表设计', 'multi-chart', 'modules/report/multi-chart', NULL, 1, NULL, '0', 17, NULL, 'list', 1, NULL, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, '0', 0, NULL, 1);
...
INSERT INTO `sys_menu` VALUES ('35', '0', '演示管理', 'demo', 'Layout', NULL, 0, NULL, '0', 60, NULL, 'star', 1, NULL, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, '0', 0, NULL, 1);
...
INSERT INTO `sys_menu` VALUES ('5', '18', '登录日志', 'log-login', 'modules/sys/log/log-login', NULL, 1, NULL, '0', 10, NULL, 'list', 1, NULL, 0, NULL, 0, NULL, NULL, NULL, 'admin', '2019-10-14 14:23:02', '0', 0, NULL, 1);
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES ('1169881651432087555', '通报批评测试', '', '2019-09-06 00:00:00', '2019-09-25 00:00:00', NULL, 'H', '2', 'ALL', '1', '2019-09-06 19:10:23', NULL, '0', 'admin', '2019-09-06 15:54:56', NULL, NULL, '[]', 1);
INSERT INTO `sys_notice` VALUES ('1190167396974813187', '', '', NULL, NULL, '', '', '', '', '', NULL, NULL, '0', '', '2019-11-01 15:23:14', '', NULL, '', 1);
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1', '超级管理员', 'admin', '全部', '超级管理员', '0', 'system', '2019-08-25 06:55:48', 'admin', '2019-10-15 10:14:35', 1);
INSERT INTO `sys_role` VALUES ('2', '普通用户', 'common', '自定义', '用于测试菜单与权限', '0', 'system', '2019-08-25 06:55:48', 'admin', '2019-10-15 10:19:59', 4);
INSERT INTO `sys_role` VALUES ('3', '普通管理员', 'ladmin', '自定义', '普通管理员级别为2，使用该角色新增用户时只能赋予比普通管理员级别低的角色', '0', 'system', '2019-09-29 17:09:57', 'admin', '2019-10-15 10:20:13', 1);
...
INSERT INTO `sys_role_menu` VALUES ('1188379789433462786', '2', '1', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789433462788', '2', '1090', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240003', '2', '11', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240005', '2', '510', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240007', '2', '512', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240009', '2', '513', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240011', '2', '514', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240013', '2', '1185020425884622849', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240015', '2', '1185020425884622850', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240017', '2', '1185020425884622851', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240019', '2', '1185020425884622852', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240021', '2', '1185020425884622853', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240023', '2', '1185020425884622854', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240025', '2', '15', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240027', '2', '610', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240029', '2', '612', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240031', '2', '613', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240033', '2', '614', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240035', '2', '2', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240037', '2', '10', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240039', '2', '12', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240041', '2', '13', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240043', '2', '14', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240045', '2', '22', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240047', '2', '3', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240049', '2', '210', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240051', '2', '212', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240053', '2', '213', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240055', '2', '214', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240057', '2', '4', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240059', '2', '310', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240061', '2', '312', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240063', '2', '313', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240065', '2', '314', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240067', '2', '9', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240069', '2', '410', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240071', '2', '412', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240073', '2', '413', NULL);
INSERT INTO `sys_role_menu` VALUES ('1188379789450240075', '2', '414', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886787', '1', '1', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886789', '1', '1090', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886791', '1', '11', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886793', '1', '510', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886795', '1', '512', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886797', '1', '513', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886799', '1', '514', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886801', '1', '1185020425884622849', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886803', '1', '1185020425884622850', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886805', '1', '1185020425884622851', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886807', '1', '1185020425884622852', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886809', '1', '1185020425884622853', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886811', '1', '1185020425884622854', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886813', '1', '1190154821818081281', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886815', '1', '1190154821818081282', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886817', '1', '1190154821818081283', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886819', '1', '1190154821818081284', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886821', '1', '1190154821818081285', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886823', '1', '1190154821818081286', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886825', '1', '15', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886827', '1', '610', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886829', '1', '612', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886831', '1', '613', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886833', '1', '614', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886835', '1', '2', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886837', '1', '10', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886839', '1', '12', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886841', '1', '13', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886843', '1', '14', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886845', '1', '22', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886847', '1', '3', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886849', '1', '210', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886851', '1', '212', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886853', '1', '213', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886855', '1', '214', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886857', '1', '4', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886859', '1', '310', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886861', '1', '312', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886863', '1', '313', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886865', '1', '314', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886867', '1', '9', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886869', '1', '410', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886871', '1', '412', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886873', '1', '413', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886875', '1', '414', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886877', '1', '1111', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886879', '1', '111111', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886881', '1', '111112', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886883', '1', '201', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886885', '1', '2011', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886887', '1', '2012', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886889', '1', '2013', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886891', '1', '2014', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886893', '1', '2015', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886895', '1', '2016', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886897', '1', '2017', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886899', '1', '1183633355286994946', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886901', '1', '1183633355286994947', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886903', '1', '1183633355286994948', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886905', '1', '1183633355286994949', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886907', '1', '1183633355286994950', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886909', '1', '1183633355286994951', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886911', '1', '1186901144051343362', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886913', '1', '1186901144051343363', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886915', '1', '1186901144051343364', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446240886917', '1', '1186901144051343365', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829827', '1', '1186901144051343366', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829829', '1', '1186901144051343367', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829831', '1', '131', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829833', '1', '132', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829835', '1', '133', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829837', '1', '134', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829839', '1', '18', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829841', '1', '1001', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829843', '1', '5', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829845', '1', '6', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829847', '1', '7', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829849', '1', '28', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829851', '1', '29', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829853', '1', '30', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829855', '1', '31', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829857', '1', '34', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829859', '1', '35', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829861', '1', '1183953818039050242', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829863', '1', '1183953818039050243', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829865', '1', '1183953818039050244', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829867', '1', '1183953818039050245', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829869', '1', '1183953818039050246', NULL);
INSERT INTO `sys_role_menu` VALUES ('1191533446282829871', '1', '1183953818039050247', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410829565954', '1', '1', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760258', '1', '1090', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760260', '1', '11', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760262', '1', '510', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760264', '1', '512', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760266', '1', '513', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760268', '1', '514', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760270', '1', '1185020425884622849', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760272', '1', '1185020425884622850', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760274', '1', '1185020425884622851', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760276', '1', '1185020425884622852', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760278', '1', '1185020425884622853', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760280', '1', '1185020425884622854', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760282', '1', '15', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760284', '1', '610', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760286', '1', '612', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760288', '1', '613', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760290', '1', '614', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410833760292', '1', '2', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954562', '1', '10', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954564', '1', '12', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954566', '1', '13', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954568', '1', '14', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954570', '1', '22', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954572', '1', '3', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954574', '1', '210', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954576', '1', '212', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954578', '1', '213', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954580', '1', '214', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954582', '1', '4', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954584', '1', '310', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954586', '1', '312', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954588', '1', '313', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954590', '1', '314', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954592', '1', '9', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954594', '1', '410', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954596', '1', '412', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954598', '1', '413', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954600', '1', '414', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954602', '1', '1111', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954604', '1', '111111', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954606', '1', '111112', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954608', '1', '201', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954610', '1', '2011', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954612', '1', '2012', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954614', '1', '2013', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954616', '1', '2014', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954618', '1', '2015', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954620', '1', '2016', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954622', '1', '2017', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954624', '1', '131', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954626', '1', '1201766516327931906', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954628', '1', '1201766516327931907', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954630', '1', '1201766516327931908', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954632', '1', '1201766516327931909', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954634', '1', '1201766516327931910', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954636', '1', '1201766516327931911', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954638', '1', '132', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954640', '1', '133', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954642', '1', '134', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954644', '1', '18', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954646', '1', '1001', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954648', '1', '5', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954650', '1', '6', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954652', '1', '7', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410837954654', '1', '28', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410842148867', '1', '29', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410842148869', '1', '30', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410842148871', '1', '31', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410842148873', '1', '34', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410842148875', '1', '35', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410842148877', '1', '1183953818039050242', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410842148879', '1', '1183953818039050243', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410842148881', '1', '1183953818039050244', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410842148883', '1', '1183953818039050245', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410842148885', '1', '1183953818039050246', NULL);
INSERT INTO `sys_role_menu` VALUES ('1209835410842148887', '1', '1183953818039050247', NULL);
...
CREATE TABLE `sys_sms`  (
  ...
  `params_1` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '参数1',
  `params_2` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '参数2',
  `params_3` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '参数3',
  `params_4` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '参数4',
  `status` tinyint(3) UNSIGNED NULL DEFAULT NULL COMMENT '发送状态  0：失败  1：成功',
  `remarks` varchar(500) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '备注信息',
  `is_deleted` char(1) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '删除状态（0，正常，1已删除）',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of sys_sms
-- ----------------------------
INSERT INTO `sys_sms` VALUES ('1184322998234750979', '18868661532', '123456', NULL, NULL, NULL, 0, NULL, '0');
INSERT INTO `sys_sms` VALUES ('1184323532597469186', '18868661532', '123456', NULL, NULL, NULL, 0, NULL, '0');
INSERT INTO `sys_sms` VALUES ('1184334182157623298', '18868661532', '123456', NULL, NULL, NULL, 1, NULL, '0');
...
CREATE TABLE `sys_sms_template`  (
  ...
  `type` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '模板类型',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '模板内容',
  `create_user` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '创建者',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_user` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '更新者',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `remarks` varchar(500) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '备注信息',
  `is_deleted` char(1) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '删除状态（0，正常，1已删除）',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
-- Table structure for sys_top_menu_setting
-- ----------------------------
DROP TABLE IF EXISTS `sys_top_menu_setting`;
CREATE TABLE `sys_top_menu_setting`  (
  `id` bigint(64) NOT NULL COMMENT '主键',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('10000', 'admin', '管理员', '116117663cd95a0821372827f1409cd1', 'PLBs9PiF', '633049326@qq.com', '17868161521', 'A01', '1', 1, NULL, NULL, NULL, NULL, '0', 'quickd', NULL, NULL, 'system', '2019-09-05 13:34:17', 'admin', '2019-09-29 16:53:27', '0', NULL, 2, NULL, NULL);
INSERT INTO `sys_user` VALUES ('1169483869655289859', 'demo', '演示', '116117663cd95a0821372827f1409cd1', 'PLBs9PiF', '633049326@qq.com', '17868161521', 'A01', '0', 1, NULL, NULL, NULL, NULL, '0', 'quickd', NULL, NULL, 'admin', '2019-09-05 13:34:17', NULL, '2019-09-05 13:34:17', '0', NULL, 1, NULL, NULL);
